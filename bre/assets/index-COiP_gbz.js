const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CBq2njpw.js","assets/vendor-JhnFXx_F.js","assets/index-CaUT83wN.css"])))=>i.map(i=>d[i]);
var rn=n=>{throw TypeError(n)};var Hn=(n,t,i)=>t.has(n)||rn("Cannot "+i);var it=(n,t,i)=>(Hn(n,t,"read from private field"),i?i.call(n):t.get(n)),Bt=(n,t,i)=>t.has(n)?rn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(n):t.set(n,i);import{s as Gn,d as on,a as Ge,p as Fe,b as we,c,e as l,i as H,f as Te,g as Oe,h as e,t as M,j as We,k as o,l as Le,u as me,m as F,n as Nt,o as Tt,q as ue,r as ce,v as w,w as Ce,x as qe,y as xe,z as ne,A as $,B as Be,C as $e,D as _,E as Yt,F as at,G as pt,H as mt,I as Nn,J as Ot,K as At,L as Tn,M as Lt,N as sn,O as On,P as Yn,Q as Qn,R as Wt,S as ln,T as Zn,U as $n,V as ea,W as ta,X as na,Y as aa,Z as ia,_ as ra,$ as oa,a0 as sa,a1 as la,a2 as ua,a3 as da,a4 as ca,a5 as pa,a6 as An,a7 as ma,a8 as fa,a9 as va,aa as ga}from"./vendor-JhnFXx_F.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const d of r)if(d.type==="childList")for(const p of d.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&a(p)}).observe(document,{childList:!0,subtree:!0});function i(r){const d={};return r.integrity&&(d.integrity=r.integrity),r.referrerPolicy&&(d.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?d.credentials="include":r.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function a(r){if(r.ep)return;r.ep=!0;const d=i(r);fetch(r.href,d)}})();const _a="modulepreload",ya=function(n){return"/bre/"+n},un={},ha=function(t,i,a){let r=Promise.resolve();if(i&&i.length>0){let p=function(D){return Promise.all(D.map(E=>Promise.resolve(E).then(R=>({status:"fulfilled",value:R}),R=>({status:"rejected",reason:R}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),u=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));r=p(i.map(D=>{if(D=ya(D),D in un)return;un[D]=!0;const E=D.endsWith(".css"),R=E?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${D}"]${R}`))return;const v=document.createElement("link");if(v.rel=E?"stylesheet":_a,E||(v.as="script"),v.crossOrigin="",v.href=D,u&&v.setAttribute("nonce",u),document.head.appendChild(v),E)return new Promise((T,C)=>{v.addEventListener("load",T),v.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${D}`)))})}))}function d(p){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=p,window.dispatchEvent(m),!m.defaultPrevented)throw p}return r.then(p=>{for(const m of p||[])m.status==="rejected"&&d(m.reason);return t().catch(d)})};function ba(n,t){let i,a;try{const E=ke.__wbindgen_add_to_stack_pointer(-16),R=jt(n,ke.__wbindgen_export,ke.__wbindgen_export2),v=tt,T=jt(t,ke.__wbindgen_export,ke.__wbindgen_export2),C=tt;ke.compile_ruleset(E,R,v,T,C);var r=Xe().getInt32(E+0,!0),d=Xe().getInt32(E+4,!0),p=Xe().getInt32(E+8,!0),m=Xe().getInt32(E+12,!0),u=r,D=d;if(m)throw u=0,D=0,Qt(p);return i=u,a=D,Ct(u,D)}finally{ke.__wbindgen_add_to_stack_pointer(16),ke.__wbindgen_export3(i,a,1)}}function dn(n,t){let i,a;try{const E=ke.__wbindgen_add_to_stack_pointer(-16),R=jt(n,ke.__wbindgen_export,ke.__wbindgen_export2),v=tt,T=jt(t,ke.__wbindgen_export,ke.__wbindgen_export2),C=tt;ke.evaluate_ruleset_with_trace(E,R,v,T,C);var r=Xe().getInt32(E+0,!0),d=Xe().getInt32(E+4,!0),p=Xe().getInt32(E+8,!0),m=Xe().getInt32(E+12,!0),u=r,D=d;if(m)throw u=0,D=0,Qt(p);return i=u,a=D,Ct(u,D)}finally{ke.__wbindgen_add_to_stack_pointer(16),ke.__wbindgen_export3(i,a,1)}}function xa(){return{__proto__:null,"./bre_core_bg.js":{__proto__:null,__wbg___wbindgen_throw_ea4887a5f8f9a9db:function(t,i){throw new Error(Ct(t,i))},__wbg_getTime_7a770f8a2ec8d634:function(t){return Rt(t).getTime()},__wbg_getTimezoneOffset_d6fba5332f80c3da:function(t){return Rt(t).getTimezoneOffset()},__wbg_new_0_1b32bedde98fef4b:function(){return xt(new Date)},__wbg_new_47ab770c8bd3b6bb:function(t){const i=new Date(Rt(t));return xt(i)},__wbindgen_cast_0000000000000001:function(t){return xt(t)},__wbindgen_cast_0000000000000002:function(t,i){const a=Ct(t,i);return xt(a)},__wbindgen_object_drop_ref:function(t){Qt(t)}}}}function xt(n){lt===Ue.length&&Ue.push(Ue.length+1);const t=lt;return lt=Ue[t],Ue[t]=n,t}function wa(n){n<1028||(Ue[n]=lt,lt=n)}let Ye=null;function Xe(){return(Ye===null||Ye.buffer.detached===!0||Ye.buffer.detached===void 0&&Ye.buffer!==ke.memory.buffer)&&(Ye=new DataView(ke.memory.buffer)),Ye}function Ct(n,t){return Da(n>>>0,t)}let rt=null;function St(){return(rt===null||rt.byteLength===0)&&(rt=new Uint8Array(ke.memory.buffer)),rt}function Rt(n){return Ue[n]}let Ue=new Array(1024).fill(void 0);Ue.push(void 0,null,!0,!1);let lt=Ue.length;function jt(n,t,i){if(i===void 0){const m=ut.encode(n),u=t(m.length,1)>>>0;return St().subarray(u,u+m.length).set(m),tt=m.length,u}let a=n.length,r=t(a,1)>>>0;const d=St();let p=0;for(;p<a;p++){const m=n.charCodeAt(p);if(m>127)break;d[r+p]=m}if(p!==a){p!==0&&(n=n.slice(p)),r=i(r,a,a=p+n.length*3,1)>>>0;const m=St().subarray(r+p,r+a),u=ut.encodeInto(n,m);p+=u.written,r=i(r,a,p,1)>>>0}return tt=p,r}function Qt(n){const t=Rt(n);return wa(n),t}let kt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});kt.decode();const Ea=2146435072;let Vt=0;function Da(n,t){return Vt+=t,Vt>=Ea&&(kt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),kt.decode(),Vt=t),kt.decode(St().subarray(n,n+t))}const ut=new TextEncoder;"encodeInto"in ut||(ut.encodeInto=function(n,t){const i=ut.encode(n);return t.set(i),{read:n.length,written:i.length}});let tt=0,ke;function Sa(n,t){return ke=n.exports,Ye=null,rt=null,ke}async function Ra(n,t){if(typeof Response=="function"&&n instanceof Response){if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(n,t)}catch(r){if(n.ok&&i(n.type)&&n.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",r);else throw r}const a=await n.arrayBuffer();return await WebAssembly.instantiate(a,t)}else{const a=await WebAssembly.instantiate(n,t);return a instanceof WebAssembly.Instance?{instance:a,module:n}:a}function i(a){switch(a){case"basic":case"cors":case"default":return!0}return!1}}async function ka(n){if(ke!==void 0)return ke;n!==void 0&&(Object.getPrototypeOf(n)===Object.prototype?{module_or_path:n}=n:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),n===void 0&&(n=new URL("/bre/assets/bre_core_bg-CaVvRRgX.wasm",import.meta.url));const t=xa();(typeof n=="string"||typeof Request=="function"&&n instanceof Request||typeof URL=="function"&&n instanceof URL)&&(n=fetch(n));const{instance:i,module:a}=await Ra(await n,t);return Sa(i)}const Ia=`<?xml version="1.0" encoding="UTF-8"?>
...
`,Aa=`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
`,wt=[{kind:"table",id:"mortgage_eligibility",title:"Mortgage eligibility",description:"Mortgage eligibility & rate assignment. Pick a scenario or drag the sliders — every change re-runs the real compiled decision table.",dmnXml:Ia,input1:{name:"dti",label:"Debt-to-income ratio",min:0,max:.6,step:.01,format:n=>n.toFixed(2)},input2:{name:"credit_score",label:"Credit score",min:500,max:850,step:5,format:n=>String(n)},flagField:"approved",amountField:"amount",flagLabel:{good:"Approved",bad:"Declined"},amountUnit:"%",presets:[{label:"Prime applicant",input1:.28,input2:780},{label:"Standard approval",input1:.4,input2:700},{label:"Declined",input1:.5,input2:620}],defaultInput1:.3,defaultInput2:760},{kind:"table",id:"insurance_underwriting",title:"Insurance underwriting",description:"Auto insurance underwriting: eligibility & base premium by driver age and at-fault claims in the last 5 years.",dmnXml:Ma,input1:{name:"driver_age",label:"Driver age",min:16,max:80,step:1,format:n=>String(n)},input2:{name:"at_fault_claims",label:"At-fault claims (5yr)",min:0,max:6,step:1,format:n=>String(n)},flagField:"approved",amountField:"amount",flagLabel:{good:"Insurable",bad:"Declined"},amountUnit:"/mo",presets:[{label:"Clean record, 30s",input1:34,input2:0},{label:"Young driver, minor claim",input1:21,input2:1},{label:"High-risk history",input1:45,input2:4}],defaultInput1:34,defaultInput2:0},{kind:"table",id:"volume_discount",title:"Volume discount pricing",description:"B2B order pricing: discount tier by order quantity and years as a loyalty customer — FIRST hit policy, most-specific rule wins.",dmnXml:Na,input1:{name:"order_quantity",label:"Order quantity",min:1,max:1e3,step:5,format:n=>String(n)},input2:{name:"loyalty_years",label:"Loyalty years",min:0,max:20,step:1,format:n=>String(n)},flagField:"approved",amountField:"amount",flagLabel:{good:"Discount applied",bad:"List price"},amountUnit:"% off",presets:[{label:"Small one-off order",input1:40,input2:0},{label:"Bulk, new customer",input1:600,input2:0},{label:"Bulk, loyal customer",input1:600,input2:5}],defaultInput1:40,defaultInput2:0},{kind:"graph",id:"insurance_premium_rating",title:"Insurance premium rating (graph)",description:"Real insurance rating engines work this way: independent rating factors compute separately, then multiply into a final premium. This is a genuine multi-node decision graph, not a flat table — watch each intermediate factor update live.",dmnXml:Ta,input1:{name:"driver_age",label:"Driver age",min:16,max:80,step:1,format:n=>String(n)},input2:{name:"at_fault_claims",label:"At-fault claims (5yr)",min:0,max:6,step:1,format:n=>String(n)},presets:[{label:"Preferred driver",input1:34,input2:0},{label:"Young driver",input1:21,input2:0},{label:"High claims history",input1:45,input2:4}],defaultInput1:34,defaultInput2:0,nodes:[{id:"age_factor",label:"Age factor",format:n=>`×${n.toFixed(2)}`},{id:"claims_factor",label:"Claims factor",format:n=>`×${n.toFixed(2)}`},{id:"final_premium",label:"Final premium",format:n=>`$${n.toFixed(2)}/mo`}],terminalNodeId:"final_premium"},{kind:"table",id:"loan_approval",title:"Loan approval",description:"Consumer loan approval & credit limit by credit score and monthly income — a FIRST-hit decision table. (Formerly one of Studio’s own hardcoded samples, unified here per BRE-122 so it also appears in Playground.)",dmnXml:Oa,input1:{name:"creditScore",label:"Credit score",min:300,max:850,step:5,format:n=>String(n)},input2:{name:"monthlyIncome",label:"Monthly income",min:0,max:15e3,step:250,format:n=>`$${n.toLocaleString()}`},flagField:"approved",amountField:"limit",flagLabel:{good:"Approved",bad:"Declined"},amountUnit:"",amountFormat:n=>`$${n.toLocaleString()}`,presets:[{label:"Strong applicant",input1:720,input2:6500},{label:"Borderline",input1:610,input2:3200},{label:"Below threshold",input1:560,input2:2e3}],defaultInput1:720,defaultInput2:6500},{kind:"generic",id:"tck_0004",title:"DMN TCK: simple table (UNIQUE)",description:"An OMG DMN Technology Compatibility Kit conformance fixture (0004-simpletable-U), demonstrating the UNIQUE hit policy over 3 mixed-type inputs (number, string, boolean). Shown as plain fields, not curated sliders — a 3-input mixed-type table genuinely doesn’t fit the 2-numeric-slider model (see BRE-122).",dmnXml:Aa,inputs:[{name:"Age",label:"Age",type:"number",default:18},{name:"RiskCategory",label:"Risk category",type:"string",options:["High","Medium","Low"],default:"Medium"},{name:"isAffordable",label:"Is affordable",type:"boolean",default:!0}],display:"table"},{kind:"generic",id:"customer_tier_routing",title:"Customer tier routing",description:"Discount % and priority shipping by loyalty tier and cart value — one string input and one numeric input, so it’s shown as plain fields rather than forced onto two numeric sliders.",dmnXml:Ca,inputs:[{name:"memberStatus",label:"Member status",type:"string",options:["gold","silver"],default:"gold"},{name:"cartValue",label:"Cart value",type:"number",default:120}],display:"table"},{kind:"generic",id:"fraud_risk_scoring",title:"Fraud risk scoring",description:"Risk score & recommended action by transaction amount and whether it’s international — a numeric input plus a boolean input, shown as plain fields.",dmnXml:ja,inputs:[{name:"amount",label:"Amount",type:"number",default:1500},{name:"isInternational",label:"International transaction",type:"boolean",default:!0}],display:"table"},{kind:"generic",id:"full_drd_elements",title:"Full DRD element types (structural demo)",description:"A structural/edge-case demo, not a realistic business scenario: exercises every DRG element type DMN defines (input data, a business knowledge model, a knowledge source, an authority requirement) alongside one real decision table. Best explored via Studio’s DRD Diagram tab; the single text input below only drives the one decision’s table.",dmnXml:qa,inputs:[{name:"Raw Input",label:"Raw input",type:"string",options:["valid","invalid"],default:"valid"}],display:"table"},{kind:"generic",id:"loan_origination",title:"Loan origination (multi-decision graph)",description:"A genuine 3-decision chain (Affordability, RiskCategory, then Routing, which requires both) over 4 primitive inputs — too many inputs and too structurally different from a flat table to force onto Playground’s 2-slider model, so it’s shown as plain fields plus the DRD diagram with live per-decision values overlaid after you run it.",dmnXml:Pa,inputs:[{name:"applicant_income",label:"Applicant income",type:"number",default:6e3},{name:"applicant_expenses",label:"Applicant expenses",type:"number",default:2500},{name:"loan_amount",label:"Loan amount",type:"number",default:1e4},{name:"credit_score",label:"Credit score",type:"number",default:720}],display:"graph"}];function cn(n){if(n.kind==="generic"){const t={};for(const i of n.inputs)t[i.name]=i.default;return t}return{[n.input1.name]:n.defaultInput1,[n.input2.name]:n.defaultInput2}}const et="https://www.omg.org/spec/DMN/20191111/MODEL/",dt="https://www.omg.org/spec/DMN/20191111/DMNDI/",ft="https://www.omg.org/spec/DMN/20211108/MODEL/",Cn="https://www.omg.org/spec/DMN/20211108/DMNDI/",vt="https://www.omg.org/spec/DMN/20230324/MODEL/",jn="https://www.omg.org/spec/DMN/20230324/DMNDI/",Qe="https://www.omg.org/spec/DMN/20250201/MODEL/",qn="https://www.omg.org/spec/DMN/20250201/DMNDI/";let ot=Qe;function Pn(n){return n&&(n.includes(Qe)?n.replaceAll(Qe,et).replaceAll(qn,dt):n.includes(vt)?n.replaceAll(vt,et).replaceAll(jn,dt):n.includes(ft)?n.replaceAll(ft,et).replaceAll(Cn,dt):n)}function ro(n){return n&&(n.includes(Qe)?ot=Qe:n.includes(vt)?ot=vt:n.includes(ft)?ot=ft:ot=et,Pn(n))}function Fn(n){return Pn(n)}function oo(n,t){if(!n)return n;const i=ot||Qe,a=i===Qe?qn:i===vt?jn:i===ft?Cn:dt;return i===et?n:n.replaceAll(et,i).replaceAll(dt,a)}const Zt=new Gn;async function Fa(n){const{rootElement:t}=await Zt.fromXML(Fn(n));return t}async function so(n){const{xml:t}=await Zt.toXML(n,{format:!0});return t}function Je(n,t={}){return Zt.create(n,t)}const La=["UNIQUE","FIRST","PRIORITY","ANY","COLLECT","RULE ORDER","OUTPUT ORDER"];function $t(n){return n.get("drgElement")||[]}function Ba(n){return n.$type==="dmn:Decision"}function lo(n){const t=n.get("decisionLogic");return t&&t.$type==="dmn:DecisionTable"?t:null}function uo(n){const t=n.get("decisionLogic");return t&&t.$type==="dmn:LiteralExpression"?t:null}function Ln(n){const t=[],i=a=>a.replace(/^#/,"");for(const a of n.get("informationRequirement")||[]){const r=a.get("requiredInput")||a.get("requiredDecision");r&&r.href&&t.push(i(r.href))}for(const a of n.get("knowledgeRequirement")||[]){const r=a.get("requiredKnowledge");r&&r.href&&t.push(i(r.href))}return t}const Ut={"dmn:Decision":"decision","dmn:InputData":"inputData","dmn:BusinessKnowledgeModel":"bkm","dmn:KnowledgeSource":"knowledgeSource"},pn={decision:{width:160,height:60},inputData:{width:140,height:50},bkm:{width:150,height:50},knowledgeSource:{width:140,height:50}};function Wa(n){const t=$t(n),i=new on.graphlib.Graph;i.setGraph({rankdir:"BT",nodesep:40,ranksep:60}),i.setDefaultEdgeLabel(()=>({}));for(const u of t){const D=Ut[u.$type];if(!D)continue;const E=pn[D];i.setNode(u.id,{...E})}const a=[];for(const u of t)if(Ut[u.$type])for(const D of Ln(u))i.node(D)&&(i.setEdge(D,u.id),a.push([D,u.id]));on.layout(i);const r=[];let d=0,p=0;for(const u of t){const D=Ut[u.$type];if(!D)continue;const E=i.node(u.id),R=pn[D];r.push({id:u.id,name:u.get("name")||u.id,type:D,x:E.x-R.width/2,y:E.y-R.height/2,width:R.width,height:R.height,element:u}),d=Math.max(d,E.x+R.width/2),p=Math.max(p,E.y+R.height/2)}const m=a.map(([u,D])=>{var E;return{from:u,to:D,points:(((E=i.edge(u,D))==null?void 0:E.points)||[]).map(R=>({x:R.x,y:R.y}))}});return{nodes:r,edges:m,width:d+40,height:p+40}}var Va=w('<span class="dt-hitpolicy-static svelte-1qozfr"> </span>'),Ua=w("<option> </option>"),Ka=w('<select class="svelte-1qozfr"></select>'),za=w('<button type="button" class="svelte-1qozfr">+ Input</button> <button type="button" class="svelte-1qozfr">+ Output</button> <button type="button" class="svelte-1qozfr">+ Rule</button>',1),mn=w('<div class="dt-col-label svelte-1qozfr"> </div>'),Ja=w('<input class="dt-col-label svelte-1qozfr" placeholder="Label"/> <input class="dt-col-expr svelte-1qozfr" placeholder="FEEL variable"/> <div class="dt-col-footer svelte-1qozfr"><input class="dt-col-type svelte-1qozfr" placeholder="type"/> <button type="button" class="dt-col-remove svelte-1qozfr" title="Remove column">&times;</button></div>',1),Xa=w('<th class="dt-input-col svelte-1qozfr"><!></th>'),Ha=w('<input class="dt-col-label svelte-1qozfr" placeholder="Label"/> <input class="dt-col-expr svelte-1qozfr" placeholder="variable name"/> <div class="dt-col-footer svelte-1qozfr"><input class="dt-col-type svelte-1qozfr" placeholder="type"/> <button type="button" class="dt-col-remove svelte-1qozfr" title="Remove column">&times;</button></div>',1),Ga=w('<th class="dt-output-col svelte-1qozfr"><!></th>'),Ya=w('<select class="dt-io-field svelte-1qozfr"><option>true</option><option>false</option></select>'),Qa=w('<input class="dt-io-field svelte-1qozfr"/>'),fn=w('<span class="dt-io-value svelte-1qozfr"> </span>'),Za=w('<td class="dt-io-cell dt-io-input svelte-1qozfr"><!></td>'),$a=w('<span class="dt-io-value dt-io-empty svelte-1qozfr">—</span>'),ei=w('<td class="dt-io-cell dt-io-output svelte-1qozfr"><!></td>'),ti=w('<tr class="dt-io-row svelte-1qozfr"><td class="dt-rownum dt-io-label svelte-1qozfr">Test</td><!><!></tr>'),ni=w('<button type="button" class="dt-row-remove svelte-1qozfr" title="Remove rule">&times;</button>'),vn=w('<input class="svelte-1qozfr"/>'),gn=w('<td class="svelte-1qozfr"><!></td>'),ai=w('<tr><td class="dt-rownum svelte-1qozfr"> <!></td><!><!></tr>'),ii=w('<div class="dt-editor svelte-1qozfr"><div class="dt-toolbar svelte-1qozfr"><label class="svelte-1qozfr">Hit policy <!></label> <!></div> <div class="dt-table-scroll svelte-1qozfr"><table><thead><tr><th class="dt-rownum svelte-1qozfr"></th><!><!></tr><!></thead><tbody></tbody></table></div></div>');function _n(n,t){Fe(t,!0);let i=we(t,"readonly",3,!1),a=we(t,"matchedRuleIndices",19,()=>[]),r=me(()=>t.decision.get("decisionLogic")),d=me(()=>e(r).get("input")),p=me(()=>e(r).get("output")),m=me(()=>e(r).get("rule"));function u(b){var f;e(r).set("hitPolicy",b),(f=t.onchange)==null||f.call(t)}function D(b,f){var x;b.set("label",f),(x=t.onchange)==null||x.call(t)}function E(b,f){var x;b.get("inputExpression").set("text",f),(x=t.onchange)==null||x.call(t)}function R(b,f){var x;b.get("inputExpression").set("typeRef",f),(x=t.onchange)==null||x.call(t)}function v(b,f){var x;b.set("name",f),(x=t.onchange)==null||x.call(t)}function T(b,f){var x;b.set("label",f),(x=t.onchange)==null||x.call(t)}function C(b,f){var x;b.set("typeRef",f),(x=t.onchange)==null||x.call(t)}function j(b,f,x){var A;b.get("inputEntry")[f].set("text",x),(A=t.onchange)==null||A.call(t)}function L(b,f,x){var A;b.get("outputEntry")[f].set("text",x),(A=t.onchange)==null||A.call(t)}function te(){var x;const b=Je("dmn:LiteralExpression",{text:""}),f=Je("dmn:InputClause",{label:"New Input",inputExpression:b});e(r).get("input").push(f);for(const A of e(m))A.get("inputEntry").push(Je("dmn:UnaryTests",{text:"-"}));(x=t.onchange)==null||x.call(t)}function ie(b){var f;e(r).get("input").splice(b,1);for(const x of e(m))x.get("inputEntry").splice(b,1);(f=t.onchange)==null||f.call(t)}function g(){var f;const b=Je("dmn:OutputClause",{name:"new_output",label:"New Output",typeRef:"string"});e(r).get("output").push(b);for(const x of e(m))x.get("outputEntry").push(Je("dmn:LiteralExpression",{text:'""'}));(f=t.onchange)==null||f.call(t)}function s(b){var f;e(r).get("output").splice(b,1);for(const x of e(m))x.get("outputEntry").splice(b,1);(f=t.onchange)==null||f.call(t)}function S(){var x;const b=e(d).map(()=>Je("dmn:UnaryTests",{text:"-"})),f=e(p).map(()=>Je("dmn:LiteralExpression",{text:'""'}));e(r).get("rule").push(Je("dmn:DecisionRule",{inputEntry:b,outputEntry:f})),(x=t.onchange)==null||x.call(t)}function G(b){var f;e(r).get("rule").splice(b,1),(f=t.onchange)==null||f.call(t)}var ge=ii(),pe=l(ge),_e=l(pe),Ee=c(l(_e));{var fe=b=>{var f=Va(),x=l(f);M(A=>F(x,A),[()=>e(r).get("hitPolicy")||"UNIQUE"]),o(b,f)},re=b=>{var f=Ka();Te(f,21,()=>La,Oe,(A,Y)=>{var ae=Ua(),K=l(ae),W={};M(()=>{F(K,e(Y)),W!==(W=e(Y))&&(ae.value=(ae.__value=e(Y))??"")}),o(A,ae)});var x;Nt(f),M(A=>{x!==(x=A)&&(f.value=(f.__value=A)??"",Tt(f,A))},[()=>e(r).get("hitPolicy")||"UNIQUE"]),ue("change",f,A=>u(A.currentTarget.value)),o(b,f)};H(Ee,b=>{i()?b(fe):b(re,-1)})}var Me=c(_e,2);{var oe=b=>{var f=za(),x=ce(f),A=c(x,2),Y=c(A,2);ue("click",x,te),ue("click",A,g),ue("click",Y,S),o(b,f)};H(Me,b=>{i()||b(oe)})}var h=c(pe,2),I=l(h);let Z;var k=l(I),y=l(k),P=c(l(y));Te(P,17,()=>e(d),Oe,(b,f,x)=>{var A=Xa(),Y=l(A);{var ae=W=>{var X=mn(),Q=l(X);M(V=>F(Q,V),[()=>e(f).get("label")||""]),o(W,X)},K=W=>{var X=Ja(),Q=ce(X),V=c(Q,2),q=c(V,2),N=l(q),O=c(N,2);M((B,ve,he)=>{Ce(Q,B),Ce(V,ve),Ce(N,he)},[()=>e(f).get("label")||"",()=>e(f).get("inputExpression").get("text")||"",()=>e(f).get("inputExpression").get("typeRef")||""]),ue("input",Q,B=>D(e(f),B.currentTarget.value)),ue("input",V,B=>E(e(f),B.currentTarget.value)),ue("input",N,B=>R(e(f),B.currentTarget.value)),ue("click",O,()=>ie(x)),o(W,X)};H(Y,W=>{i()?W(ae):W(K,-1)})}o(b,A)});var z=c(P);Te(z,17,()=>e(p),Oe,(b,f,x)=>{var A=Ga(),Y=l(A);{var ae=W=>{var X=mn(),Q=l(X);M(V=>F(Q,V),[()=>e(f).get("label")||""]),o(W,X)},K=W=>{var X=Ha(),Q=ce(X),V=c(Q,2),q=c(V,2),N=l(q),O=c(N,2);M((B,ve,he)=>{Ce(Q,B),Ce(V,ve),Ce(N,he)},[()=>e(f).get("label")||"",()=>e(f).get("name")||"",()=>e(f).get("typeRef")||""]),ue("input",Q,B=>T(e(f),B.currentTarget.value)),ue("input",V,B=>v(e(f),B.currentTarget.value)),ue("input",N,B=>C(e(f),B.currentTarget.value)),ue("click",O,()=>s(x)),o(W,X)};H(Y,W=>{i()?W(ae):W(K,-1)})}o(b,A)});var de=c(y);{var ee=b=>{var f=ti(),x=c(l(f));Te(x,17,()=>e(d),Oe,(Y,ae)=>{const K=me(()=>e(ae).get("inputExpression").get("text")||""),W=me(()=>(e(ae).get("inputExpression").get("typeRef")||"").toLowerCase());var X=Za(),Q=l(X);{var V=N=>{var O=qe(),B=ce(O);{var ve=De=>{var J=Ya(),U=l(J);U.value=U.__value="true";var le=c(U);le.value=le.__value="false";var Se;Nt(J),M(Ie=>{Se!==(Se=Ie)&&(J.value=(J.__value=Ie)??"",Tt(J,Ie))},[()=>String(t.inputValues[e(K)])]),ue("change",J,Ie=>{var Re;return(Re=t.onInputValueChange)==null?void 0:Re.call(t,e(K),Ie.currentTarget.value)}),o(De,J)},he=De=>{var J=Qa();M(()=>{ne(J,"type",e(W)==="number"?"number":"text"),Ce(J,t.inputValues[e(K)])}),ue("input",J,U=>{var le;return(le=t.onInputValueChange)==null?void 0:le.call(t,e(K),U.currentTarget.value)}),o(De,J)};H(B,De=>{e(W)==="boolean"?De(ve):De(he,-1)})}o(N,O)},q=N=>{var O=fn(),B=l(O);M(ve=>F(B,ve),[()=>String(t.outputValues[e(K)])]),o(N,O)};H(Q,N=>{t.inputValues&&t.inputValues[e(K)]!==void 0?N(V):t.outputValues&&t.outputValues[e(K)]!==void 0&&N(q,1)})}o(Y,X)});var A=c(x);Te(A,17,()=>e(p),Oe,(Y,ae)=>{const K=me(()=>e(ae).get("name")||"");var W=ei(),X=l(W);{var Q=q=>{var N=fn(),O=l(N);M(B=>F(O,B),[()=>String(t.outputValues[e(K)])]),o(q,N)},V=q=>{var N=$a();o(q,N)};H(X,q=>{t.outputValues&&t.outputValues[e(K)]!==void 0?q(Q):q(V,-1)})}o(Y,W)}),o(b,f)};H(de,b=>{!i()&&(t.inputValues||t.outputValues)&&b(ee)})}var se=c(k);Te(se,21,()=>e(m),Oe,(b,f,x)=>{var A=ai();let Y;var ae=l(A),K=l(ae);K.nodeValue=`${x+1} `;var W=c(K);{var X=q=>{var N=ni();ue("click",N,()=>G(x)),o(q,N)};H(W,q=>{i()||q(X)})}var Q=c(ae);Te(Q,17,()=>e(f).get("inputEntry"),Oe,(q,N,O)=>{var B=gn(),ve=l(B);{var he=J=>{var U=xe();M(le=>F(U,le),[()=>e(N).get("text")||"-"]),o(J,U)},De=J=>{var U=vn();M(le=>Ce(U,le),[()=>e(N).get("text")||""]),ue("input",U,le=>j(e(f),O,le.currentTarget.value)),o(J,U)};H(ve,J=>{i()?J(he):J(De,-1)})}o(q,B)});var V=c(Q);Te(V,17,()=>e(f).get("outputEntry"),Oe,(q,N,O)=>{var B=gn(),ve=l(B);{var he=J=>{var U=xe();M(le=>F(U,le),[()=>e(N).get("text")||""]),o(J,U)},De=J=>{var U=vn();M(le=>Ce(U,le),[()=>e(N).get("text")||""]),ue("input",U,le=>L(e(f),O,le.currentTarget.value)),o(J,U)};H(ve,J=>{i()?J(he):J(De,-1)})}o(q,B)}),M(q=>Y=We(A,1,"svelte-1qozfr",null,Y,q),[()=>({matched:a().includes(x)})]),o(b,A)}),M(()=>Z=We(I,1,"dt-table svelte-1qozfr",null,Z,{readonly:i()})),o(n,ge),Le()}Ge(["change","click","input"]);var ri=w('<span class="le-type-static svelte-125hirw"> </span>'),oi=w('<input placeholder="e.g. number" class="svelte-125hirw"/>'),si=w('<input class="le-io-input svelte-125hirw"/>'),li=w('<span class="le-io-value svelte-125hirw"> </span>'),ui=w('<div class="le-io-field svelte-125hirw"><label class="svelte-125hirw"> </label> <!></div>'),di=w('<div class="le-io-row svelte-125hirw"><!> <div class="le-io-field le-io-result svelte-125hirw"><label for="le-io-result" class="svelte-125hirw"> </label> <span id="le-io-result" class="le-io-value svelte-125hirw"> </span></div></div>'),ci=w('<pre class="le-textarea le-static svelte-125hirw"> </pre>'),pi=w('<textarea class="le-textarea svelte-125hirw" placeholder="FEEL expression, e.g. 400 * age_factor * claims_factor" spellcheck="false"></textarea>'),mi=w('<div class="le-editor svelte-125hirw"><div class="le-toolbar svelte-125hirw"><label class="svelte-125hirw">Result type <!></label></div> <!> <!></div>');function co(n,t){Fe(t,!0);let i=we(t,"readonly",3,!1),a=me(()=>t.decision.get("decisionLogic"));function r(g){var s;e(a).set("text",g),(s=t.onchange)==null||s.call(t)}function d(g){var S;const s=t.decision.get("variable");s&&(s.set("typeRef",g),(S=t.onchange)==null||S.call(t))}let p=me(()=>{const g=t.decision.$parent;if(!g)return[];const s=new Map($t(g).map(S=>[S.id,S]));return Ln(t.decision).map(S=>s.get(S)).filter(S=>!!S).map(S=>({id:S.id,name:S.get("name")||S.id}))}),m=me(()=>{var g;return((g=t.decision.get("variable"))==null?void 0:g.get("name"))||t.decision.get("name")});var u=mi(),D=l(u),E=l(D),R=c(l(E));{var v=g=>{var s=ri(),S=l(s);M(G=>F(S,G),[()=>{var G;return((G=t.decision.get("variable"))==null?void 0:G.get("typeRef"))||""}]),o(g,s)},T=g=>{var s=oi();M(S=>Ce(s,S),[()=>{var S;return((S=t.decision.get("variable"))==null?void 0:S.get("typeRef"))||""}]),ue("input",s,S=>d(S.currentTarget.value)),o(g,s)};H(R,g=>{i()?g(v):g(T,-1)})}var C=c(D,2);{var j=g=>{var s=di(),S=l(s);Te(S,17,()=>e(p),fe=>fe.id,(fe,re)=>{var Me=ui(),oe=l(Me),h=l(oe),I=c(oe,2);{var Z=y=>{var P=si();M(()=>{ne(P,"id",`le-io-${e(re).id}`),Ce(P,t.inputValues[e(re).name])}),ue("input",P,z=>{var de;return(de=t.onInputValueChange)==null?void 0:de.call(t,e(re).name,z.currentTarget.value)}),o(y,P)},k=y=>{var P=li(),z=l(P);M(de=>{ne(P,"id",`le-io-${e(re).id}`),F(z,de)},[()=>t.outputValues&&t.outputValues[e(re).name]!==void 0?String(t.outputValues[e(re).name]):"—"]),o(y,P)};H(I,y=>{t.inputValues&&t.inputValues[e(re).name]!==void 0?y(Z):y(k,-1)})}M(()=>{ne(oe,"for",`le-io-${e(re).id}`),F(h,e(re).name)}),o(fe,Me)});var G=c(S,2),ge=l(G),pe=l(ge),_e=c(ge,2),Ee=l(_e);M(fe=>{F(pe,`${e(m)??""} (result)`),F(Ee,fe)},[()=>t.outputValues&&t.outputValues[e(m)]!==void 0?String(t.outputValues[e(m)]):"—"]),o(g,s)};H(C,g=>{!i()&&(t.inputValues||t.outputValues)&&(e(p).length>0||t.outputValues)&&g(j)})}var L=c(C,2);{var te=g=>{var s=ci(),S=l(s);M(G=>F(S,G),[()=>e(a).get("text")||""]),o(g,s)},ie=g=>{var s=pi();M(S=>Ce(s,S),[()=>e(a).get("text")||""]),ue("input",s,S=>r(S.currentTarget.value)),o(g,s)};H(L,g=>{i()?g(te):g(ie,-1)})}o(n,u),Le()}Ge(["input"]);var fi=at('<path fill="none" stroke="var(--muted)" stroke-width="1.5" marker-end="url(#drd-arrow)"></path>'),vi=at('<rect rx="24" ry="24" class="svelte-1jgcg8n"></rect>'),gi=at('<rect rx="4" ry="4" class="svelte-1jgcg8n"></rect>'),_i=at('<text text-anchor="middle" dominant-baseline="middle" font-size="11" font-weight="600" fill="var(--ink)"> </text><text text-anchor="middle" dominant-baseline="middle" font-size="13" font-weight="700" fill="var(--accent)"> </text>',1),yi=at('<text text-anchor="middle" dominant-baseline="middle" font-size="12" font-weight="600" fill="var(--ink)"> </text>'),hi=at('<g role="button" tabindex="0"><!><!></g>'),bi=w('<div class="drd-wrap svelte-1jgcg8n"><svg class="drd-svg svelte-1jgcg8n" role="application" aria-label="Decision requirements diagram, drag to pan, scroll to zoom"><defs><marker id="drd-arrow" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth"><path d="M0,0 L0,6 L9,3 z" fill="var(--muted)"></path></marker></defs><!><!></svg></div>');function yn(n,t){Fe(t,!0);let i=me(()=>Wa(t.definitions)),a=$(Be({x:0,y:0,w:800,h:500})),r=$(!1),d={x:0,y:0},p={x:0,y:0};$e(()=>{_(a,{x:0,y:0,w:Math.max(e(i).width,400),h:Math.max(e(i).height,300)},!0)});function m(g){g.preventDefault();const s=g.deltaY>0?1.1:.9,S=Math.max(200,Math.min(4e3,e(a).w*s)),G=Math.max(150,Math.min(3e3,e(a).h*s));_(a,{...e(a),w:S,h:G},!0)}function u(g){g.target.closest(".drd-node")||(_(r,!0),d={x:g.clientX,y:g.clientY},p={x:e(a).x,y:e(a).y})}function D(g,s){if(!e(r))return;const S=e(a).w/s.clientWidth;_(a,{...e(a),x:p.x-(g.clientX-d.x)*S,y:p.y-(g.clientY-d.y)*S},!0)}function E(){_(r,!1)}function R(g){switch(g){case"decision":return"var(--accent-wash)";case"inputData":return"var(--good-wash)";case"bkm":return"var(--stamp-wash)";default:return"var(--bg)"}}function v(g){switch(g){case"decision":return"var(--accent)";case"inputData":return"var(--good)";case"bkm":return"var(--stamp)";default:return"var(--muted)"}}function T(g){return g.points.length?g.points.map((s,S)=>`${S===0?"M":"L"} ${s.x} ${s.y}`).join(" "):""}function C(g){if(!t.nodeValues)return null;const s=g.id in t.nodeValues?t.nodeValues[g.id]:t.nodeValues[g.name];return s===void 0?null:t.formatNodeValue?t.formatNodeValue(g.id,s):String(s)}var j=bi(),L=l(j),te=c(l(L));Te(te,17,()=>e(i).edges,Oe,(g,s)=>{var S=fi();M(G=>ne(S,"d",G),[()=>T(e(s))]),o(g,S)});var ie=c(te);Te(ie,17,()=>e(i).nodes,Oe,(g,s)=>{const S=me(()=>C(e(s)));var G=hi();let ge;var pe=l(G);{var _e=oe=>{var h=vi();M((I,Z)=>{ne(h,"x",e(s).x),ne(h,"y",e(s).y),ne(h,"width",e(s).width),ne(h,"height",e(s).height),ne(h,"fill",I),ne(h,"stroke",Z),ne(h,"stroke-width",e(s).id===t.activeId?2.5:1.5)},[()=>R(e(s).type),()=>v(e(s).type)]),o(oe,h)},Ee=oe=>{var h=gi();M((I,Z)=>{ne(h,"x",e(s).x),ne(h,"y",e(s).y),ne(h,"width",e(s).width),ne(h,"height",e(s).height),ne(h,"fill",I),ne(h,"stroke",Z),ne(h,"stroke-width",e(s).id===t.activeId?2.5:1.5)},[()=>R(e(s).type),()=>v(e(s).type)]),o(oe,h)};H(pe,oe=>{e(s).type==="inputData"?oe(_e):oe(Ee,-1)})}var fe=c(pe);{var re=oe=>{var h=_i(),I=ce(h),Z=l(I),k=c(I),y=l(k);M(()=>{ne(I,"x",e(s).x+e(s).width/2),ne(I,"y",e(s).y+e(s).height*.4),F(Z,e(s).name),ne(k,"x",e(s).x+e(s).width/2),ne(k,"y",e(s).y+e(s).height*.68),F(y,e(S))}),o(oe,h)},Me=oe=>{var h=yi(),I=l(h);M(()=>{ne(h,"x",e(s).x+e(s).width/2),ne(h,"y",e(s).y+e(s).height/2),F(I,e(s).name)}),o(oe,h)};H(fe,oe=>{e(S)!==null?oe(re):oe(Me,-1)})}M(()=>ge=We(G,0,"drd-node svelte-1jgcg8n",null,ge,{active:e(s).id===t.activeId,static:!t.onselect})),ue("click",G,()=>{var oe;return(oe=t.onselect)==null?void 0:oe.call(t,e(s).id)}),ue("keydown",G,oe=>{var h;return oe.key==="Enter"&&((h=t.onselect)==null?void 0:h.call(t,e(s).id))}),o(g,G)}),M(()=>ne(L,"viewBox",`${e(a).x??""} ${e(a).y??""} ${e(a).w??""} ${e(a).h??""}`)),Yt("wheel",L,m),ue("pointerdown",L,u),ue("pointermove",L,g=>D(g,g.currentTarget)),ue("pointerup",L,E),Yt("pointerleave",L,E),o(n,j),Le()}Ge(["pointerdown","pointermove","pointerup","click","keydown"]);const Ke=Be({current:null,facts:{}});var xi=w("<div><!></div>");function qt(n,t){let i=we(t,"direction",3,"row"),a=we(t,"bordered",3,!1),r=we(t,"gap",3,"var(--sp-2)"),d=we(t,"class",3,"");var p=xi();let m,u;var D=l(p);pt(D,()=>t.children??mt),M(()=>{m=We(p,1,`tab-group ${d()??""}`,"svelte-13apwse",m,{bordered:a()}),u=Nn(p,"",u,{"flex-direction":i(),gap:r()})}),o(n,p)}var wi=w("<button><!></button>");function gt(n,t){let i=we(t,"active",3,!1),a=we(t,"variant",3,"pill"),r=we(t,"fullWidth",3,!1),d=we(t,"disabled",3,!1),p=we(t,"type",3,"button");var m=wi();let u;var D=l(m);pt(D,()=>t.children??mt),M(()=>{ne(m,"type",p()),u=We(m,1,`tab tab-${a()??""}`,"svelte-184qymf",u,{active:i(),"full-width":r()}),m.disabled=d(),ne(m,"aria-pressed",i())}),ue("click",m,function(...E){var R;(R=t.onclick)==null||R.apply(this,E)}),o(n,m)}Ge(["click"]);var Ei=w("<div><!></div>");function Ze(n,t){let i=we(t,"padding",3,"var(--sp-5)"),a=we(t,"class",3,"");var r=Ei();let d;var p=l(r);pt(p,()=>t.children??mt),M(()=>{We(r,1,`panel ${a()??""}`,"svelte-hxsa5u"),d=Nn(r,"",d,{padding:i()})}),o(n,r)}var Di=new Set(["$$slots","$$events","$$legacy","value","type","variant","class"]),hn=w("<input/>");function He(n,t){Fe(t,!0);let i=we(t,"value",15),a=we(t,"type",3,"text"),r=we(t,"variant",3,"default"),d=we(t,"class",3,""),p=Tn(t,Di);var m=qe(),u=ce(m);{var D=R=>{var v=hn();Ot(v,()=>({type:"number",class:`input input-${r()??""} ${d()??""}`,...p}),void 0,void 0,void 0,"svelte-8ff5h4",!0),At(v,i),o(R,v)},E=R=>{var v=hn();Ot(v,()=>({type:a(),class:`input input-${r()??""} ${d()??""}`,...p}),void 0,void 0,void 0,"svelte-8ff5h4",!0),At(v,i),o(R,v)};H(u,R=>{a()==="number"?R(D):R(E,-1)})}o(n,m),Le()}var Si=w('<!> <div class="field svelte-175p7lt"><label for="input1" class="svelte-175p7lt"> <!></label> <input id="input1" type="range" class="svelte-175p7lt"/></div> <div class="field svelte-175p7lt"><label for="input2" class="svelte-175p7lt"> <!></label> <input id="input2" type="range" class="svelte-175p7lt"/></div>',1),Ri=w('<select class="generic-select svelte-175p7lt"><option>true</option><option>false</option></select>'),ki=w("<option> </option>"),Ii=w('<select class="generic-select svelte-175p7lt"></select>'),Mi=w('<div class="field generic-field svelte-175p7lt"><label class="svelte-175p7lt"> </label> <!></div>'),Ni=w('<div class="verdict bad svelte-175p7lt"><div class="status svelte-175p7lt">Example error</div> <div class="error-detail mono svelte-175p7lt"> </div></div>'),Ti=w('<div><div class="status svelte-175p7lt"> </div> <div class="rate mono svelte-175p7lt"> </div></div>'),Oi=w('<div class="verdict good svelte-175p7lt"><div class="status svelte-175p7lt"> </div> <div class="rate mono svelte-175p7lt"> </div></div>'),Ai=w('<pre class="generic-result mono svelte-175p7lt"> </pre>'),Ci=w('<div class="rate mono svelte-175p7lt">—</div>'),ji=w('<div class="verdict good generic-verdict svelte-175p7lt"><div class="status svelte-175p7lt">Result</div> <!></div>'),qi=w('<h2 class="eyebrow svelte-175p7lt">Facts</h2> <p class="lede svelte-175p7lt"> </p> <!> <!>',1),Pi=w(`<h2 class="eyebrow svelte-175p7lt">Decision table &mdash; unavailable</h2> <p class="lede svelte-175p7lt">This example didn't parse/compile cleanly -- see the error detail in the left panel.</p>`,1),bn=w('<div class="table-host svelte-175p7lt"><!></div>'),xn=w('<h2 class="eyebrow svelte-175p7lt">Decision table &mdash; live</h2> <p class="lede svelte-175p7lt"> </p> <!>',1),wn=w('<div class="graph-host svelte-175p7lt"><!></div>'),Fi=w(`Every node above was actually evaluated by the real engine — the terminal node's own expression reads the
          other two nodes' <b>results</b>, not the raw facts, exactly like a real DMN decision requirements graph.`,1),Li=w('<h2 class="eyebrow svelte-175p7lt">Decision graph &mdash; live</h2> <p class="lede svelte-175p7lt"> </p> <!> <div class="trace mono svelte-175p7lt"><!></div>',1),Bi=w('<h2 class="eyebrow svelte-175p7lt">Decision graph &mdash; live</h2> <p class="lede svelte-175p7lt"> </p> <!>',1),Wi=w('<h1 class="page-title svelte-175p7lt">Playground</h1> <!> <div class="stage svelte-175p7lt"><!> <!></div>',1);function Vi(n,t){Fe(t,!0);let i=$(0),a=me(()=>wt[e(i)]),r=$(0),d=$(0),p=$(Be({})),m=$("loading the engine…"),u=$(!1),D=!1,E=$(null),R=null,v=$(null),T=$(!0),C=$(null),j=$(Be([])),L=$(Be({})),te=$(null),ie=$(Be({})),g=$(0),s=me(()=>{if(!e(E))return null;const k=$t(e(E)).filter(Ba);return e(a).kind==="generic"&&e(a).display==="table"&&e(a).decisionId?k.find(y=>y.id===e(a).decisionId)||k[0]||null:k[0]||null});$e(()=>{Ke.current=e(a),Ke.facts=e(a).kind==="generic"?{...e(p)}:{[e(a).input1.name]:e(r),[e(a).input2.name]:e(d)}});async function S(k){try{_(E,await Fa(k.dmnXml),!0),R=ba("dmn-xml",JSON.stringify(Fn(k.dmnXml))),_(v,null)}catch(y){R=null,_(E,null),_(v,`This example failed to compile: ${(y==null?void 0:y.message)??String(y)}`),console.error("Failed to load/compile example",k.id,y)}}function G(){if(!R)return;const k=e(a);try{if(k.kind==="generic"){const ee={};for(const f of k.inputs)ee[f.name]=e(p)[f.name];const se=dn(R,JSON.stringify(ee)),b=JSON.parse(se);if(_(te,b.result,!0),k.display==="table")_(j,b.trace&&b.trace.matched_rules||[],!0);else{const f=b.trace&&b.trace.intermediates||{},x=typeof b.result=="object"&&b.result?b.result:{};_(ie,{...f,...x},!0)}return}const y={};y[k.input1.name]=e(r),y[k.input2.name]=e(d);const P=dn(R,JSON.stringify(y)),z=JSON.parse(P);if(k.kind==="graph"){const ee=z.trace&&z.trace.intermediates||{},se={};for(const b of k.nodes)se[b.id]=ee[b.id];_(L,se,!0);return}const de=z.result;_(j,z.trace&&z.trace.matched_rules||[],!0),_(T,!!de[k.flagField]),_(C,de[k.flagField]?de[k.amountField]:null,!0)}catch(y){_(v,`This example failed to evaluate: ${(y==null?void 0:y.message)??String(y)}`),console.error("Failed to evaluate example",k.id,y)}}async function ge(k){_(i,k,!0);const y=wt[k];_(g,y.kind==="generic"?null:0,!0),_(v,null),_(te,null),_(ie,{},!0),_(j,[],!0),_(L,{},!0),y.kind==="generic"?_(p,cn(y),!0):(_(r,y.defaultInput1,!0),_(d,y.defaultInput2,!0)),D&&(await S(y),G())}function pe(k){e(a).kind!=="generic"&&(_(r,e(a).presets[k].input1,!0),_(d,e(a).presets[k].input2,!0),_(g,k,!0),G())}function _e(){_(g,null),G()}function Ee(k,y){if(e(a).kind==="generic")return;const P=k===1?e(a).input1:e(a).input2;let z=parseFloat(y);isNaN(z)&&(z=k===1?e(r):e(d)),z=Math.min(P.max,Math.max(P.min,z)),k===1?_(r,z,!0):_(d,z,!0),_(g,null),G()}function fe(k,y){_(p,{...e(p),[k]:y},!0),_(g,null),G()}function re(k,y){const P=e(a).kind==="graph"?e(a).nodes.find(z=>z.id===k):void 0;return P?P.format(y):String(y)}Lt(async()=>{try{await ka(),D=!0;const k=wt[e(i)];k.kind==="generic"?_(p,cn(k),!0):(_(r,k.defaultInput1,!0),_(d,k.defaultInput2,!0)),await S(e(a)),_(m,"compiled and running — real engine, in your browser, zero network calls."),G()}catch(k){_(u,!0),_(m,"engine failed to load: "+((k==null?void 0:k.message)??String(k))),console.error(k)}});var Me=Wi(),oe=c(ce(Me),2);qt(oe,{class:"example-tabs",children:(k,y)=>{var P=qe(),z=ce(P);Te(z,17,()=>wt,Oe,(de,ee,se)=>{{let b=me(()=>e(i)===se);gt(de,{get active(){return e(b)},onclick:()=>ge(se),children:(f,x)=>{var A=xe();M(()=>F(A,e(ee).title)),o(f,A)},$$slots:{default:!0}})}}),o(k,P)},$$slots:{default:!0}});var h=c(oe,2),I=l(h);Ze(I,{padding:"20px",children:(k,y)=>{var P=qi(),z=c(ce(P),2),de=l(z),ee=c(z,2);{var se=K=>{var W=Si(),X=ce(W);qt(X,{direction:"column",gap:"6px",class:"presets",children:(U,le)=>{var Se=qe(),Ie=ce(Se);Te(Ie,17,()=>e(a).presets,Oe,(Re,Ve,Ae)=>{{let ze=me(()=>e(g)===Ae);gt(Re,{variant:"list",get active(){return e(ze)},onclick:()=>pe(Ae),children:(bt,nn)=>{var an=xe();M(()=>F(an,e(Ve).label)),o(bt,an)},$$slots:{default:!0}})}}),o(U,Se)},$$slots:{default:!0}});var Q=c(X,2),V=l(Q),q=l(V),N=c(q);He(N,{class:"mono",variant:"inline",type:"number",get min(){return e(a).input1.min},get max(){return e(a).input1.max},get step(){return e(a).input1.step},get value(){return e(r)},onchange:U=>Ee(1,U.currentTarget.value)});var O=c(V,2),B=c(Q,2),ve=l(B),he=l(ve),De=c(he);He(De,{class:"mono",variant:"inline",type:"number",get min(){return e(a).input2.min},get max(){return e(a).input2.max},get step(){return e(a).input2.step},get value(){return e(d)},onchange:U=>Ee(2,U.currentTarget.value)});var J=c(ve,2);M(()=>{F(q,`${e(a).input1.label??""} `),ne(O,"min",e(a).input1.min),ne(O,"max",e(a).input1.max),ne(O,"step",e(a).input1.step),F(he,`${e(a).input2.label??""} `),ne(J,"min",e(a).input2.min),ne(J,"max",e(a).input2.max),ne(J,"step",e(a).input2.step)}),ue("input",O,_e),At(O,()=>e(r),U=>_(r,U)),ue("input",J,_e),At(J,()=>e(d),U=>_(d,U)),o(K,W)},b=K=>{var W=qe(),X=ce(W);Te(X,17,()=>e(a).inputs,Oe,(Q,V)=>{var q=Mi(),N=l(q),O=l(N),B=c(N,2);{var ve=J=>{var U=Ri(),le=l(U);le.value=le.__value="true";var Se=c(le);Se.value=Se.__value="false";var Ie;Nt(U),M(Re=>{ne(U,"id",`generic-${e(V).name}`),Ie!==(Ie=Re)&&(U.value=(U.__value=Re)??"",Tt(U,Re))},[()=>String(e(p)[e(V).name])]),ue("change",U,Re=>fe(e(V).name,Re.currentTarget.value==="true")),o(J,U)},he=J=>{var U=Ii();Te(U,21,()=>e(V).options,Oe,(Se,Ie)=>{var Re=ki(),Ve=l(Re),Ae={};M(()=>{F(Ve,e(Ie)),Ae!==(Ae=e(Ie))&&(Re.value=(Re.__value=e(Ie))??"")}),o(Se,Re)});var le;Nt(U),M(()=>{ne(U,"id",`generic-${e(V).name}`),le!==(le=e(p)[e(V).name])&&(U.value=(U.__value=e(p)[e(V).name])??"",Tt(U,e(p)[e(V).name]))}),ue("change",U,Se=>fe(e(V).name,Se.currentTarget.value)),o(J,U)},De=J=>{{let U=me(()=>`generic-${e(V).name}`),le=me(()=>e(V).type==="number"?"number":"text");He(J,{get id(){return e(U)},class:"mono",get type(){return e(le)},get value(){return e(p)[e(V).name]},onchange:Se=>fe(e(V).name,e(V).type==="number"?parseFloat(Se.currentTarget.value):Se.currentTarget.value)})}};H(B,J=>{e(V).type==="boolean"?J(ve):e(V).options?J(he,1):J(De,-1)})}M(()=>{ne(N,"for",`generic-${e(V).name}`),F(O,e(V).label)}),o(Q,q)}),o(K,W)};H(ee,K=>{e(a).kind!=="generic"?K(se):K(b,-1)})}var f=c(ee,2);{var x=K=>{var W=Ni(),X=c(l(W),2),Q=l(X);M(()=>F(Q,e(v))),o(K,W)},A=K=>{var W=Ti();let X;var Q=l(W),V=l(Q),q=c(Q,2),N=l(q);M(O=>{X=We(W,1,"verdict svelte-175p7lt",null,X,{good:e(T),bad:!e(T)}),F(V,e(T)?e(a).flagLabel.good:e(a).flagLabel.bad),F(N,O)},[()=>e(T)&&e(C)!==null?e(a).amountFormat?e(a).amountFormat(e(C)):`${e(C)}${e(a).amountUnit}`:"—"]),o(K,W)},Y=K=>{var W=Oi(),X=l(W),Q=l(X),V=c(X,2),q=l(V);M((N,O)=>{F(Q,N),F(q,O)},[()=>{var N;return(N=e(a).nodes.find(O=>O.id===e(a).terminalNodeId))==null?void 0:N.label},()=>e(L)[e(a).terminalNodeId]!==void 0?re(e(a).terminalNodeId,e(L)[e(a).terminalNodeId]):"—"]),o(K,W)},ae=K=>{var W=ji(),X=c(l(W),2);{var Q=q=>{var N=Ai(),O=l(N);M(B=>F(O,B),[()=>JSON.stringify(e(te),null,2)]),o(q,N)},V=q=>{var N=Ci();o(q,N)};H(X,q=>{e(te)?q(Q):q(V,-1)})}o(K,W)};H(f,K=>{e(v)?K(x):e(a).kind==="table"?K(A,1):e(a).kind==="graph"?K(Y,2):K(ae,-1)})}M(()=>F(de,e(a).description)),o(k,P)},$$slots:{default:!0}});var Z=c(I,2);Ze(Z,{padding:"20px",children:(k,y)=>{var P=qe(),z=ce(P);{var de=x=>{var A=Pi();o(x,A)},ee=x=>{var A=xn(),Y=c(ce(A),2),ae=l(Y),K=c(Y,2);{var W=X=>{var Q=bn(),V=l(Q);_n(V,{get decision(){return e(s)},readonly:!0,get matchedRuleIndices(){return e(j)}}),o(X,Q)};H(K,X=>{e(s)&&X(W)})}M(()=>F(ae,e(m))),o(x,A)},se=x=>{var A=Li(),Y=c(ce(A),2),ae=l(Y),K=c(Y,2);{var W=N=>{var O=wn(),B=l(O);yn(B,{get definitions(){return e(E)},activeId:null,get nodeValues(){return e(L)},formatNodeValue:re}),o(N,O)};H(K,N=>{e(E)&&N(W)})}var X=c(K,2),Q=l(X);{var V=N=>{var O=Fi();o(N,O)},q=N=>{var O=xe("Waiting on the engine…");o(N,O)};H(Q,N=>{e(L)[e(a).terminalNodeId]!==void 0?N(V):e(u)||N(q,1)})}M(()=>F(ae,`${e(m)??""} Each box is a real node in a compiled decision graph — the two factor nodes evaluate independently, then the terminal node combines them.`)),o(x,A)},b=x=>{var A=xn(),Y=c(ce(A),2),ae=l(Y),K=c(Y,2);{var W=X=>{var Q=bn(),V=l(Q);_n(V,{get decision(){return e(s)},readonly:!0,get matchedRuleIndices(){return e(j)}}),o(X,Q)};H(K,X=>{e(s)&&X(W)})}M(()=>F(ae,e(m))),o(x,A)},f=x=>{var A=Bi(),Y=c(ce(A),2),ae=l(Y),K=c(Y,2);{var W=X=>{var Q=wn(),V=l(Q);yn(V,{get definitions(){return e(E)},activeId:null,get nodeValues(){return e(ie)}}),o(X,Q)};H(K,X=>{e(E)&&X(W)})}M(()=>F(ae,`${e(m)??""} A genuine multi-decision chain — each box is evaluated by the compiled engine; values appear once evaluated.`)),o(x,A)};H(z,x=>{e(v)?x(de):e(a).kind==="table"?x(ee,1):e(a).kind==="graph"?x(se,2):e(a).display==="table"?x(b,3):x(f,-1)})}o(k,P)},$$slots:{default:!0}}),o(n,Me),Le()}Ge(["input","change"]);const en="bre_playground_token",tn="bre_playground_tenant",Bn="bre_playground_org_names";function Wn(){if(typeof window>"u")return{};try{const n=localStorage.getItem(Bn);return n?JSON.parse(n):{}}catch{return{}}}function Vn(n){return n?Wn()[n]??null:null}function Ui(){if(typeof window>"u")return{token:null,tenantId:null,orgName:null};const n=localStorage.getItem(en),t=localStorage.getItem(tn);return{token:n,tenantId:t,orgName:Vn(t)}}const be=Be(Ui());function En(n,t){be.token=n,be.tenantId=t,be.orgName=Vn(t),localStorage.setItem(en,n),t&&localStorage.setItem(tn,t)}function Ki(n,t){const i=Wn();i[n]=t,localStorage.setItem(Bn,JSON.stringify(i)),be.tenantId===n&&(be.orgName=t)}function zi(){be.token=null,be.tenantId=null,be.orgName=null,localStorage.removeItem(en),localStorage.removeItem(tn)}const Ji="bre_studio_handoff";function Un(n){localStorage.setItem(Ji,JSON.stringify(n))}const _t="/bre/",Kn={playground:"","sdk-sandbox":"sdk-sandbox",docs:"docs",account:"account",studio:"studio",privacy:"privacy",terms:"terms"},Xi=Object.fromEntries(Object.entries(Kn).map(([n,t])=>[t,n]));function zn(n){const i=(n.startsWith(_t)?n.slice(_t.length):n.replace(/^\//,"")).replace(/\/$/,"");return Xi[i]??"playground"}function Dn(){return typeof window>"u"?"playground":window.location.hash.includes("google_auth=")?"account":zn(window.location.pathname)}function Pe(n){const t=Kn[n];return t?`${_t}${t}`:_t}var yt,ht;class Hi{constructor(){Bt(this,yt,$(Be(Dn())));Bt(this,ht,$(0));typeof window<"u"&&(window.addEventListener("popstate",()=>{this.current=Dn()}),window.addEventListener("click",t=>{var d,p;if(t.defaultPrevented||t.button!==0||t.metaKey||t.ctrlKey||t.shiftKey||t.altKey)return;const i=(p=(d=t.target)==null?void 0:d.closest)==null?void 0:p.call(d,"a");if(!i||i.hasAttribute("download"))return;const a=i.getAttribute("target");if(a&&a!=="_self")return;const r=i.getAttribute("href");!r||!r.startsWith(_t)||(t.preventDefault(),history.pushState(null,"",r),this.current=zn(r))}))}get current(){return e(it(this,yt))}set current(t){_(it(this,yt),t,!0)}get studioHandoffTick(){return e(it(this,ht))}set studioHandoffTick(t){_(it(this,ht),t,!0)}navigate(t){typeof window>"u"||(history.pushState(null,"",Pe(t)),this.current=t)}bumpStudioHandoff(){this.studioHandoffTick++}}yt=new WeakMap,ht=new WeakMap;const ye=new Hi;var Gi=new Set(["$$slots","$$events","$$legacy","children","variant","fullWidth","disabled","type","href","onclick","class"]),Yi=w("<a><!></a>"),Qi=w("<button><!></button>");function je(n,t){let i=we(t,"variant",3,"secondary"),a=we(t,"fullWidth",3,!1),r=we(t,"disabled",3,!1),d=we(t,"type",3,"button"),p=we(t,"class",3,""),m=Tn(t,Gi);var u=qe(),D=ce(u);{var E=v=>{var T=Yi();Ot(T,()=>({href:t.href,class:`btn btn-${i()??""} ${p()??""}`,"aria-disabled":r(),onclick:t.onclick,...m,[sn]:{"full-width":a()}}),void 0,void 0,void 0,"svelte-18sv61c");var C=l(T);pt(C,()=>t.children??mt),o(v,T)},R=v=>{var T=Qi();Ot(T,()=>({type:d(),class:`btn btn-${i()??""} ${p()??""}`,disabled:r(),onclick:t.onclick,...m,[sn]:{"full-width":a()}}),void 0,void 0,void 0,"svelte-18sv61c");var C=l(T);pt(C,()=>t.children??mt),o(v,T)};H(D,v=>{t.href?v(E):v(R,-1)})}o(n,u)}var Zi=w('<!> <div class="divider svelte-11w59y9"><span>or log in</span></div>',1),$i=w(`<p class="signup-disabled-note svelte-11w59y9">New accounts are created by signing in with Google. Already have an
        account? Log in below.</p> <!>`,1),Kt=w("<!> <!>",1),er=w('<!> <div class="divider svelte-11w59y9"><span>or</span></div>',1),tr=w('<label class="svelte-11w59y9">Organization name <!></label>'),nr=w('<div class="api-key-box svelte-11w59y9"><div class="label svelte-11w59y9">Your API key (shown once — save it now):</div> <code class="mono svelte-11w59y9"> </code></div>'),ar=w('<!> <form class="svelte-11w59y9"><!> <label class="svelte-11w59y9">Email <!></label> <label class="svelte-11w59y9">Password <!></label> <!></form> <!>',1),ir=w('<div class="empty svelte-11w59y9">None yet.</div>'),rr=w('<li class="ruleset-row svelte-11w59y9"><div class="ruleset-info svelte-11w59y9"><span class="mono name svelte-11w59y9"> </span> <span class="meta svelte-11w59y9"> </span></div> <div class="ruleset-actions svelte-11w59y9"><!> <!></div></li>'),or=w('<ul class="svelte-11w59y9"></ul>'),sr=w(`<div class="signed-in svelte-11w59y9"><div class="row svelte-11w59y9"><span>Signed in <!></span> <!></div> <!> <div class="saved-list svelte-11w59y9"><div class="label svelte-11w59y9">Saved rulesets:</div> <p class="note svelte-11w59y9">Saved to your bre-service account — separate from Studio's local "Save to Library," which stays in this browser only.</p> <!></div></div>`),lr=w('<div class="error mono svelte-11w59y9"> </div>'),ur=w('<div class="intro svelte-11w59y9"><h1 class="page-title">Your account</h1> <p class="svelte-11w59y9">Sign up or log in to save Playground rulesets to a real bre-service backend.</p></div> <!> <!>',1),dr=w('<p class="viewer-status svelte-11w59y9">Loading…</p>'),cr=w('<p class="viewer-status error-text svelte-11w59y9"> </p>'),pr=w('<pre class="viewer-content mono svelte-11w59y9"> </pre>'),mr=w('<div class="viewer-backdrop svelte-11w59y9" role="presentation"><div class="viewer-panel svelte-11w59y9" role="dialog" tabindex="-1"><div class="viewer-header svelte-11w59y9"><span class="mono"> </span> <!></div> <!></div></div>');function fr(n,t){Fe(t,!0);const i="https://api.datalila.com";let a=$("signup"),r=$(""),d=$(""),p=$(""),m=$(""),u=$(!1),D=$(null),E=$(Be([])),R=$(null),v=$(null),T=$(!1),C=$(null),j=$(!1),L=$(!1);Lt(()=>{be.token&&G(),te(),fetch(`${i}/health`).then(h=>h.ok?h.json():null).then(h=>{_(j,!!(h!=null&&h.google_signin_available)),_(L,!!(h!=null&&h.public_signup_requires_google)),e(L)&&e(a)==="signup"&&_(a,"login")}).catch(()=>{})});function te(){const h=window.location.hash;if(!h||!h.includes("google_auth="))return;const I=new URLSearchParams(h.replace(/^#/,"")),Z=I.get("google_auth");if(Z==="success"){const k=I.get("token"),y=I.get("tenant_id");k&&(En(k,y),G())}else Z==="error"&&_(D,I.get("message")??"Google sign-in failed.",!0);history.replaceState(null,"",window.location.pathname+window.location.search)}function ie(){window.location.href=`${i}/api/v1/auth/oidc/signup/google`}async function g(){_(D,null),_(u,!0);try{if(e(a)==="signup"){const h=await fetch(`${i}/api/v1/auth/register`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({tenant_name:e(r),email:e(d),password:e(p)})});if(!h.ok)throw new Error(await h.text());const I=await h.json();_(m,I.api_key,!0),I.tenant_id&&e(r)&&Ki(I.tenant_id,e(r)),await s()}else await s()}catch(h){_(D,(h==null?void 0:h.message)??String(h),!0)}finally{_(u,!1)}}async function s(){const h=await fetch(`${i}/api/v1/auth/login`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({email:e(d),password:e(p)})});if(!h.ok){const k=await h.text();throw new Error(k||`login failed (HTTP ${h.status}): check email/password`)}const I=await h.json(),Z=I.token??I.access_token??I.jwt;if(!Z)throw new Error("login succeeded but no token found in response: "+JSON.stringify(I));En(Z,I.tenant_id??be.tenantId??null),await G()}function S(){zi(),_(m,""),_(E,[],!0),_e()}async function G(){if(be.token)try{const h=await fetch(`${i}/api/v1/rulesets`,{headers:{Authorization:`Bearer ${be.token}`}});if(!h.ok)throw new Error(await h.text());const I=await h.json();_(E,Array.isArray(I)?I:[],!0)}catch(h){_(D,"Could not load saved rulesets: "+((h==null?void 0:h.message)??String(h)))}}async function ge(){if(!be.token)return;const h=Ke.current;if(!h){_(D,"No example is currently open in Playground to save.");return}_(D,null),_(u,!0);try{const I=await fetch(`${i}/api/v1/rulesets/register`,{method:"POST",headers:{"content-type":"application/json",Authorization:`Bearer ${be.token}`},body:JSON.stringify({name:h.id,format:"dmn-xml",content:h.dmnXml})});if(!I.ok)throw new Error(await I.text());const Z=await I.json();if(Z&&typeof Z=="object"&&"Err"in Z)throw new Error(Z.Err);await G()}catch(I){_(D,(I==null?void 0:I.message)??String(I),!0)}finally{_(u,!1)}}async function pe(h){_(R,h,!0),_(v,null),_(C,null),_(T,!0);try{const I=await fetch(`${i}/api/v1/rulesets/blob/${h.latest_hash}`,{headers:{Authorization:`Bearer ${be.token}`}});if(!I.ok)throw new Error(await I.text());_(v,await I.text(),!0)}catch(I){_(C,(I==null?void 0:I.message)??String(I),!0)}finally{_(T,!1)}}function _e(){_(R,null),_(v,null),_(C,null)}async function Ee(h){if(be.token){_(D,null);try{const I=await fetch(`${i}/api/v1/rulesets/blob/${h.latest_hash}`,{headers:{Authorization:`Bearer ${be.token}`}});if(!I.ok)throw new Error(await I.text());const Z=await I.text();Un({dmnXml:Z}),ye.bumpStudioHandoff(),ye.navigate("studio")}catch(I){_(D,`Could not open "${h.name}" in Studio: `+((I==null?void 0:I.message)??String(I)))}}}var fe=Kt(),re=ce(fe);Ze(re,{class:"account-panel",padding:"20px",children:(h,I)=>{var Z=ur(),k=c(ce(Z),2);{var y=ee=>{var se=ar(),b=ce(se);{var f=O=>{var B=$i(),ve=c(ce(B),2);{var he=De=>{var J=Zi(),U=ce(J);je(U,{variant:"secondary",fullWidth:!0,onclick:ie,children:(le,Se)=>{var Ie=xe("Sign in with Google");o(le,Ie)},$$slots:{default:!0}}),o(De,J)};H(ve,De=>{e(j)&&De(he)})}o(O,B)},x=O=>{var B=Kt(),ve=ce(B);qt(ve,{class:"tabs",children:(J,U)=>{var le=Kt(),Se=ce(le);{let Re=me(()=>e(a)==="signup");gt(Se,{fullWidth:!0,get active(){return e(Re)},onclick:()=>_(a,"signup"),children:(Ve,Ae)=>{var ze=xe("Sign up");o(Ve,ze)},$$slots:{default:!0}})}var Ie=c(Se,2);{let Re=me(()=>e(a)==="login");gt(Ie,{fullWidth:!0,get active(){return e(Re)},onclick:()=>_(a,"login"),children:(Ve,Ae)=>{var ze=xe("Log in");o(Ve,ze)},$$slots:{default:!0}})}o(J,le)},$$slots:{default:!0}});var he=c(ve,2);{var De=J=>{var U=er(),le=ce(U);je(le,{variant:"secondary",fullWidth:!0,onclick:ie,children:(Se,Ie)=>{var Re=xe("Sign in with Google");o(Se,Re)},$$slots:{default:!0}}),o(J,U)};H(he,J=>{e(j)&&J(De)})}o(O,B)};H(b,O=>{e(L)?O(f):O(x,-1)})}var A=c(b,2),Y=l(A);{var ae=O=>{var B=tr(),ve=c(l(B));He(ve,{type:"text",required:!0,get value(){return e(r)},set value(he){_(r,he,!0)}}),o(O,B)};H(Y,O=>{e(a)==="signup"&&!e(L)&&O(ae)})}var K=c(Y,2),W=c(l(K));He(W,{type:"email",required:!0,get value(){return e(d)},set value(O){_(d,O,!0)}});var X=c(K,2),Q=c(l(X));He(Q,{type:"password",required:!0,minlength:8,get value(){return e(p)},set value(O){_(p,O,!0)}});var V=c(X,2);je(V,{type:"submit",variant:"primary",fullWidth:!0,get disabled(){return e(u)},children:(O,B)=>{var ve=xe();M(()=>F(ve,e(u)?"Working…":e(a)==="signup"&&!e(L)?"Create account":"Log in")),o(O,ve)},$$slots:{default:!0}});var q=c(A,2);{var N=O=>{var B=nr(),ve=c(l(B),2),he=l(ve);M(()=>F(he,e(m))),o(O,B)};H(q,O=>{e(m)&&O(N)})}Yt("submit",A,O=>{O.preventDefault(),g()}),o(ee,se)},P=ee=>{var se=sr(),b=l(se),f=l(b),x=c(l(f));{var A=q=>{var N=xe();M(()=>F(N,`— ${be.orgName??""}`)),o(q,N)},Y=q=>{var N=xe();M(()=>F(N,`— tenant ${be.tenantId??""}`)),o(q,N)};H(x,q=>{be.orgName?q(A):be.tenantId&&q(Y,1)})}var ae=c(f,2);je(ae,{variant:"secondary",onclick:S,children:(q,N)=>{var O=xe("Log out");o(q,O)},$$slots:{default:!0}});var K=c(b,2);{let q=me(()=>e(u)||!Ke.current);je(K,{variant:"primary",fullWidth:!0,onclick:ge,get disabled(){return e(q)},children:(N,O)=>{var B=xe();M(()=>F(B,e(u)?"Saving…":Ke.current?`Save "${Ke.current.title}" to your account`:"Open an example in Playground to save it")),o(N,B)},$$slots:{default:!0}})}var W=c(K,2),X=c(l(W),4);{var Q=q=>{var N=ir();o(q,N)},V=q=>{var N=or();Te(N,21,()=>e(E),O=>O.id,(O,B)=>{var ve=rr(),he=l(ve),De=l(he),J=l(De),U=c(De,2),le=l(U),Se=c(he,2),Ie=l(Se);je(Ie,{variant:"ghost",onclick:()=>pe(e(B)),children:(Ae,ze)=>{var bt=xe("View");o(Ae,bt)},$$slots:{default:!0}});var Re=c(Ie,2);{var Ve=Ae=>{je(Ae,{variant:"ghost",onclick:()=>Ee(e(B)),children:(ze,bt)=>{var nn=xe("Open in Studio →");o(ze,nn)},$$slots:{default:!0}})};H(Re,Ae=>{e(B).format==="dmn-xml"&&Ae(Ve)})}M(()=>{F(J,e(B).name),F(le,`v${e(B).version??""} · ${e(B).format??""}`)}),o(O,ve)}),o(q,N)};H(X,q=>{e(E).length===0?q(Q):q(V,-1)})}o(ee,se)};H(k,ee=>{be.token?ee(P,-1):ee(y)})}var z=c(k,2);{var de=ee=>{var se=lr(),b=l(se);M(()=>F(b,e(D))),o(ee,se)};H(z,ee=>{e(D)&&ee(de)})}o(h,Z)},$$slots:{default:!0}});var Me=c(re,2);{var oe=h=>{var I=mr(),Z=l(I),k=l(Z),y=l(k),P=l(y),z=c(y,2);je(z,{variant:"secondary",onclick:_e,children:(f,x)=>{var A=xe("Close");o(f,A)},$$slots:{default:!0}});var de=c(k,2);{var ee=f=>{var x=dr();o(f,x)},se=f=>{var x=cr(),A=l(x);M(()=>F(A,e(C))),o(f,x)},b=f=>{var x=pr(),A=l(x);M(()=>F(A,e(v))),o(f,x)};H(de,f=>{e(T)?f(ee):e(C)?f(se,1):f(b,-1)})}M(()=>{ne(Z,"aria-label",`Viewing ${e(R).name}`),F(P,e(R).name)}),ue("click",I,_e),ue("keydown",I,f=>{f.key==="Escape"&&_e()}),ue("click",Z,f=>f.stopPropagation()),o(h,I)};H(Me,h=>{e(R)&&h(oe)})}o(n,fe),Le()}Ge(["click","keydown"]);function vr(n,t){let i,a;try{const p=Ft(n,Ne.__wbindgen_malloc,Ne.__wbindgen_realloc),m=nt,u=Ft(t,Ne.__wbindgen_malloc,Ne.__wbindgen_realloc),D=nt,E=Ne.compile_ruleset(p,m,u,D);var r=E[0],d=E[1];if(E[3])throw r=0,d=0,Jn(E[2]);return i=r,a=d,Pt(r,d)}finally{Ne.__wbindgen_free(i,a,1)}}function gr(n,t){let i,a;try{const p=Ft(n,Ne.__wbindgen_malloc,Ne.__wbindgen_realloc),m=nt,u=Ft(t,Ne.__wbindgen_malloc,Ne.__wbindgen_realloc),D=nt,E=Ne.evaluate_ruleset_with_trace(p,m,u,D);var r=E[0],d=E[1];if(E[3])throw r=0,d=0,Jn(E[2]);return i=r,a=d,Pt(r,d)}finally{Ne.__wbindgen_free(i,a,1)}}function _r(){return{__proto__:null,"./bre_core_bg.js":{__proto__:null,__wbg___wbindgen_throw_ea4887a5f8f9a9db:function(t,i){throw new Error(Pt(t,i))},__wbg_getTime_7a770f8a2ec8d634:function(t){return t.getTime()},__wbg_getTimezoneOffset_d6fba5332f80c3da:function(t){return t.getTimezoneOffset()},__wbg_new_0_1b32bedde98fef4b:function(){return new Date},__wbg_new_47ab770c8bd3b6bb:function(t){return new Date(t)},__wbindgen_cast_0000000000000001:function(t){return t},__wbindgen_cast_0000000000000002:function(t,i){return Pt(t,i)},__wbindgen_init_externref_table:function(){const t=Ne.__wbindgen_externrefs,i=t.grow(4);t.set(0,void 0),t.set(i+0,void 0),t.set(i+1,null),t.set(i+2,!0),t.set(i+3,!1)}}}}function Pt(n,t){return hr(n>>>0,t)}let st=null;function It(){return(st===null||st.byteLength===0)&&(st=new Uint8Array(Ne.memory.buffer)),st}function Ft(n,t,i){if(i===void 0){const m=ct.encode(n),u=t(m.length,1)>>>0;return It().subarray(u,u+m.length).set(m),nt=m.length,u}let a=n.length,r=t(a,1)>>>0;const d=It();let p=0;for(;p<a;p++){const m=n.charCodeAt(p);if(m>127)break;d[r+p]=m}if(p!==a){p!==0&&(n=n.slice(p)),r=i(r,a,a=p+n.length*3,1)>>>0;const m=It().subarray(r+p,r+a),u=ct.encodeInto(n,m);p+=u.written,r=i(r,a,p,1)>>>0}return nt=p,r}function Jn(n){const t=Ne.__wbindgen_externrefs.get(n);return Ne.__externref_table_dealloc(n),t}let Mt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});Mt.decode();const yr=2146435072;let zt=0;function hr(n,t){return zt+=t,zt>=yr&&(Mt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}),Mt.decode(),zt=t),Mt.decode(It().subarray(n,n+t))}const ct=new TextEncoder;"encodeInto"in ct||(ct.encodeInto=function(n,t){const i=ct.encode(n);return t.set(i),{read:n.length,written:i.length}});let nt=0,Ne;function br(n,t){return Ne=n.exports,st=null,Ne.__wbindgen_start(),Ne}async function xr(n,t){if(typeof Response=="function"&&n instanceof Response){if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(n,t)}catch(r){if(n.ok&&i(n.type)&&n.headers.get("Content-Type")!=="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",r);else throw r}const a=await n.arrayBuffer();return await WebAssembly.instantiate(a,t)}else{const a=await WebAssembly.instantiate(n,t);return a instanceof WebAssembly.Instance?{instance:a,module:n}:a}function i(a){switch(a){case"basic":case"cors":case"default":return!0}return!1}}async function wr(n){if(Ne!==void 0)return Ne;n!==void 0&&(Object.getPrototypeOf(n)===Object.prototype?{module_or_path:n}=n:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),n===void 0&&(n=new URL("/bre/assets/bre_core_bg-C6Hq1jXb.wasm",import.meta.url));const t=_r();(typeof n=="string"||typeof Request=="function"&&n instanceof Request||typeof URL=="function"&&n instanceof URL)&&(n=fetch(n));const{instance:i,module:a}=await xr(await n,t);return br(i)}let Jt=null;function Er(){return Jt||(Jt=wr()),Jt}const Dr=Object.freeze(Object.defineProperty({__proto__:null,compile_ruleset:vr,ensureReady:Er,evaluate_ruleset_with_trace:gr},Symbol.toStringTag,{value:"Module"})),Sr=On(Dr),Rr={},kr=Object.freeze(Object.defineProperty({__proto__:null,default:Rr},Symbol.toStringTag,{value:"Module"})),Sn=On(kr);var Xt,Rn;function Ir(){if(Rn)return Xt;Rn=1;let n,t;try{n=Sn,t=Sn}catch{n=null,t=null}function i(d){const p=()=>t.join(t.dirname(d),"blobs");return{ready:Promise.resolve(),isSync:!0,readRawMetaFile(){return n.existsSync(d)?n.readFileSync(d,"utf8"):null},writeRawMetaFile(m){const u=t.dirname(d);n.existsSync(u)||n.mkdirSync(u,{recursive:!0}),n.writeFileSync(d,m,"utf8")},hasBlob(m){return n.existsSync(t.join(p(),`${m}.bin`))},readBlob(m){return n.readFileSync(t.join(p(),`${m}.bin`)).toString("utf8")},writeBlob(m,u){const D=p();n.existsSync(D)||n.mkdirSync(D,{recursive:!0}),n.writeFileSync(t.join(D,`${m}.bin`),u,"utf8")}}}function a(d){const p="bre-js-cache",u=`${d}::meta`,D=g=>`${d}::blob::${g}`;let E=null;const R=new Map;function v(){return new Promise((g,s)=>{const S=indexedDB.open(p,1);S.onupgradeneeded=()=>{S.result.objectStoreNames.contains("kv")||S.result.createObjectStore("kv")},S.onsuccess=()=>g(S.result),S.onerror=()=>s(S.error)})}function T(g,s){return new Promise((S,G)=>{const pe=g.transaction("kv","readonly").objectStore("kv").get(s);pe.onsuccess=()=>S(pe.result),pe.onerror=()=>G(pe.error)})}function C(g,s){return new Promise((S,G)=>{const pe=g.transaction("kv","readonly").objectStore("kv"),_e=IDBKeyRange.bound(s,s+"￿"),Ee=new Map,fe=pe.openCursor(_e);fe.onsuccess=()=>{const re=fe.result;if(!re){S(Ee);return}Ee.set(re.key.slice(s.length),re.value),re.continue()},fe.onerror=()=>G(fe.error)})}function j(g,s,S){return new Promise((G,ge)=>{const pe=g.transaction("kv","readwrite");pe.objectStore("kv").put(S,s),pe.oncomplete=()=>G(),pe.onerror=()=>ge(pe.error)})}let L=null;function te(){return L||(L=v()),L}return{ready:(async()=>{const g=await te(),s=await T(g,u);s!==void 0&&(E=s);const S=`${d}::blob::`,G=await C(g,S);for(const[ge,pe]of G)R.set(ge,pe)})(),isSync:!1,readRawMetaFile(){return E},writeRawMetaFile(g){E=g,te().then(s=>j(s,u,g)).catch(s=>{console.error("bre-js: failed to persist cache to IndexedDB:",s)})},hasBlob(g){return R.has(g)},readBlob(g){return R.get(g)},writeBlob(g,s){R.set(g,s),te().then(S=>j(S,D(g),s)).catch(S=>{console.error("bre-js: failed to persist blob to IndexedDB:",S)})}}}function r(d){return typeof window<"u"&&typeof window.indexedDB<"u"?a(d):i(d)}return Xt={createCacheStore:r},Xt}var Ht,kn;function Mr(){if(kn)return Ht;kn=1;const n=Sr,{parse:t,stringify:i}=Yn(),a=Qn(),{createCacheStore:r}=Ir(),d={test:R=>a.isDecimal(R),stringify:R=>R.toString()};function p(R){if(/^-?\d+$/.test(R)){const v=Number(R);if(Number.isSafeInteger(v))return v}return new a(R)}function m(R){return t(R,void 0,{parseNumber:p})}function u(R,v){return i(R,void 0,v,[d])}class D{constructor({endpoint:v,apiKey:T,tenantId:C,cacheDbPath:j,syncIntervalMs:L=5e3,auditFlushIntervalMs:te=5e3}){if(this.endpoint=v.replace(/\/$/,""),this.apiKey=T,this.tenantId=C||"default",this.cacheDbPath=j||"./bre_js_cache.json",this.syncIntervalMs=L,this.auditFlushIntervalMs=te,this.rulesetCache={},this.rulesetsMeta={},this.auditQueue=[],this.syncInterval=null,this.auditInterval=null,this.store=r(this.cacheDbPath),this.store.isSync)this.loadLocalCache(),this.ready=Promise.resolve();else{const ie=n.ensureReady?n.ensureReady():Promise.resolve();this.ready=Promise.all([this.store.ready,ie]).then(()=>this.loadLocalCache())}}loadLocalCache(){try{const v=this.store.readRawMetaFile();if(v){const T=m(v);this.rulesetsMeta=T.rulesetsMeta||{},this.auditQueue=T.auditQueue||[];for(const[C,j]of Object.entries(this.rulesetsMeta))if(this.store.hasBlob(j.hash)){const L=this.store.readBlob(j.hash);let te;j.format==="dmn-xml"?te=L:te=JSON.parse(L);try{const ie=n.compile_ruleset(j.format,JSON.stringify(te));this.rulesetCache[C]=JSON.parse(ie)}catch(ie){console.error(`Failed to compile cached ruleset ${C}:`,ie)}}}}catch(v){console.error("Failed to load local cache:",v)}}saveLocalCache(){try{const v={rulesetsMeta:this.rulesetsMeta,auditQueue:this.auditQueue};this.store.writeRawMetaFile(u(v,2))}catch(v){console.error("Failed to save local cache:",v)}}async syncOnce(){const v={"X-API-Key":this.apiKey},T=await fetch(`${this.endpoint}/api/v1/rulesets`,{headers:v});if(!T.ok)throw new Error(`Server returned error: ${T.status}`);const C=await T.json();for(const j of C){const L=this.rulesetsMeta[j.name];if(!L||L.hash!==j.latest_hash){const te=await fetch(`${this.endpoint}/api/v1/rulesets/blob/${j.latest_hash}`,{headers:v});if(!te.ok)continue;const ie=te.headers.get("X-Ruleset-Format")||j.format,g=new TextDecoder("utf-8").decode(await te.arrayBuffer());this.store.writeBlob(j.latest_hash,g),this.rulesetsMeta[j.name]={id:j.id,name:j.name,version:j.version,format:ie,hash:j.latest_hash};let s;ie==="dmn-xml"?s=g:s=JSON.parse(g);try{const S=n.compile_ruleset(ie,JSON.stringify(s));this.rulesetCache[j.name]=JSON.parse(S)}catch(S){console.error(`Compile error for ${j.name}:`,S)}}}this.saveLocalCache()}evaluate(v,T){const C=this.rulesetCache[v],j=this.rulesetsMeta[v];if(!C||!j)throw new Error(`Ruleset not found in cache: ${v}`);try{const L=JSON.stringify(C),te=u(T),ie=n.evaluate_ruleset_with_trace(L,te),g=m(ie),s=g.result,S=g.trace;return this.queueAuditLog(v,T,s,!0,null,S),s}catch(L){const te=L.message||String(L);throw this.queueAuditLog(v,T,null,!1,te,{matched_rules:[],duration_us:0}),L}}queueAuditLog(v,T,C,j,L,te){const ie=this.rulesetsMeta[v];ie&&(this.auditQueue.push({ruleset_id:ie.id,version:ie.version,definition_hash:ie.hash,inputs:T,outputs:C,success:j,error_message:L,trace_json:te}),this.saveLocalCache())}async flushAuditLogs(){if(this.auditQueue.length===0)return;const v=[...this.auditQueue],T={"X-API-Key":this.apiKey,"Content-Type":"application/json"},C=await fetch(`${this.endpoint}/api/v1/analytics/logs`,{method:"POST",headers:T,body:u({logs:v})});if(C.ok)this.auditQueue=this.auditQueue.slice(v.length),this.saveLocalCache();else throw new Error(`Failed to upload audit logs: ${C.statusText}`)}startSyncLoops(){this.syncInterval=setInterval(()=>{this.syncOnce().catch(v=>console.error("JS Client sync failed:",v))},this.syncIntervalMs),this.auditInterval=setInterval(()=>{this.flushAuditLogs().catch(v=>console.error("JS Client audit flush failed:",v))},this.auditFlushIntervalMs)}close(){this.syncInterval&&clearInterval(this.syncInterval),this.auditInterval&&clearInterval(this.auditInterval)}}class E{constructor({policy:v={},defaultRoute:T="local",local:C,remote:j}={}){this.policy=v,this.defaultRoute=T,C instanceof D?this.localClient=C:C?this.localClient=new D(C):this.localClient=null,j?(this.remoteEndpoint=j.endpoint.replace(/\/$/,""),this.remoteApiKey=j.apiKey):(this.remoteEndpoint=null,this.remoteApiKey=null)}get ready(){return this.localClient?this.localClient.ready:Promise.resolve()}async syncOnce(){if(!this.localClient)throw new Error("SmartBreClient: no local client configured (pass `local` at construction) to sync");return this.localClient.syncOnce()}routeFor(v){return this.policy[v]||this.defaultRoute}async evaluate(v,T){const C=this.routeFor(v);if(C==="server"||C==="remote")return this.evaluateRemote(v,T);if(C==="local"){if(!this.localClient)throw new Error(`SmartBreClient: ruleset '${v}' is routed to 'local' but no local client is configured`);return this.localClient.evaluate(v,T)}throw new Error(`SmartBreClient: unknown route '${C}' for ruleset '${v}' (expected 'local' or 'server')`)}async evaluateRemote(v,T){if(!this.remoteEndpoint)throw new Error(`SmartBreClient: ruleset '${v}' is routed to 'server' but no remote config was provided (pass \`remote: { endpoint, apiKey }\` at construction)`);const C={"X-API-Key":this.remoteApiKey,"Content-Type":"application/json"},j=await fetch(`${this.remoteEndpoint}/api/v1/decide`,{method:"POST",headers:C,body:u({ruleSet:v,facts:T})});if(!j.ok)throw new Error(`Remote evaluate failed for '${v}': ${j.status} ${await j.text()}`);const L=m(await j.text());if(!L.success)throw new Error(`Remote evaluate failed for '${v}': ${L.error_message}`);return L.output_payload}close(){this.localClient&&this.localClient.close()}}return Ht={BreClient:D,SmartBreClient:E,Decimal:a},Ht}var In=Mr(),Nr=w('<div class="cm-host svelte-1g4qxuv"></div>');function Tr(n,t){Fe(t,!0);let i=we(t,"value",15,""),a=we(t,"readOnly",3,!1),r,d=null;const p=Wt.theme({"&":{color:"var(--ink)",backgroundColor:"var(--bg)",fontSize:"12.5px",height:"100%"},".cm-content":{fontFamily:'ui-monospace, "SF Mono", Menlo, monospace',padding:"10px 0",caretColor:"var(--accent)"},".cm-gutters":{backgroundColor:"var(--bg)",color:"var(--muted)",border:"none"},".cm-activeLine":{backgroundColor:"var(--accent-wash)"},".cm-activeLineGutter":{backgroundColor:"var(--accent-wash)"},"&.cm-focused":{outline:"none"},".cm-scroller":{overflow:"auto",fontFamily:"inherit"},".cm-matchingBracket":{backgroundColor:"var(--accent-wash)",outline:"1px solid var(--accent)"}});Lt(()=>{d=new Wt({parent:r,state:ln.create({doc:i(),extensions:[Zn(),$n(),ea(),ta(),na(),aa(),ia(pa,{fallback:!0}),ra({typescript:!0}),oa.of([{key:"Mod-Enter",run:()=>{var u;return(u=t.onRun)==null||u.call(t),!0}},sa,...la,...ua]),p,ln.readOnly.of(a()),Wt.updateListener.of(u=>{u.docChanged&&i(u.state.doc.toString())})]})})}),da(()=>d==null?void 0:d.destroy()),$e(()=>{d&&i()!==d.state.doc.toString()&&d.dispatch({changes:{from:0,to:d.state.doc.length,insert:i()}})});var m=Nr();ca(m,u=>r=u,()=>r),o(n,m),Le()}var Or=w('<div class="panel-head svelte-1yde3g3"><h3 class="eyebrow svelte-1yde3g3">Code <span class="badge svelte-1yde3g3">editable</span></h3> <div class="actions svelte-1yde3g3"><button type="button" class="reset svelte-1yde3g3">Reset to example</button> <button type="button" class="run svelte-1yde3g3">Run <span class="hint svelte-1yde3g3">⌘/Ctrl+Enter</span></button></div></div> <div class="editor-host svelte-1yde3g3"><!></div>',1),Ar=w('<div class="error svelte-1yde3g3"> </div>'),Cr=w('<div class="result"><div class="result-label svelte-1yde3g3">your code returned</div> <pre class="result-json svelte-1yde3g3"> </pre></div>'),jr=w('<h3 class="eyebrow svelte-1yde3g3">Facts</h3> <label class="svelte-1yde3g3">Debt-to-income ratio <!></label> <label class="svelte-1yde3g3">Credit score <!></label> <div class="status svelte-1yde3g3"> </div> <!> <!>',1),qr=w(`<div class="sandbox svelte-1yde3g3"><h1 class="page-title">Try the JS / TS SDK</h1> <p class="lede svelte-1yde3g3">This runs the real <code class="svelte-1yde3g3">datalila-bre</code> npm package, unmodified — the same code you'd \`npm install\` — right here in
...
`;var Xr=w('<div class="legal svelte-1gmktme"><!></div>');function Xn(n,t){Fe(t,!0);let i=me(()=>ma.parse(t.markdown,{async:!1}));var a=Xr(),r=l(a);Ze(r,{padding:"20px 22px",children:(d,p)=>{var m=qe(),u=ce(m);An(u,()=>e(i)),o(d,m)},$$slots:{default:!0}}),o(n,a),Le()}function Hr(n){Xn(n,{get markdown(){return Jr}})}const Gr=`# Terms of Service
...
`;function Yr(n){Xn(n,{get markdown(){return Gr}})}var Mn=w('<div class="view-wrap svelte-1n46o8q"><!></div>'),Qr=w("<!> <!>",1),Zr=w('<p class="studio-loading svelte-1n46o8q">Loading Studio…</p>'),$r=w("<div><!></div>"),eo=w('<span class="build-info-detail svelte-1n46o8q">commit <code class="svelte-1n46o8q"></code> </span>'),to=w('<header class="bar svelte-1n46o8q"><div><span class="word svelte-1n46o8q">Datalila <span class="accent svelte-1n46o8q">BRE</span></span> <span class="tag svelte-1n46o8q">A 100% OMG Compliant Business Rules Engine. Executing live in your browser.</span></div> <nav class="svelte-1n46o8q"><!> <!> <!> <!></nav></header> <main><!></main> <!> <footer>Running the actual Datalila BRE engine directly in your browser. Same code, same execution, zero server latency. <!> <span class="build-info">· <a>Privacy</a> · <a>Terms</a> · <button type="button" class="build-info-toggle svelte-1n46o8q">Build info</button> <!></span></footer>',1);function no(n,t){Fe(t,!0);let i=$(!1);$e(()=>{});const a={playground:"Playground","sdk-sandbox":"Try the JS / TS SDK",docs:"SDK examples",account:"Your account",studio:"Studio",privacy:"Privacy Policy",terms:"Terms of Service"};$e(()=>{document.title=`Datalila BRE — ${a[ye.current]}`});let r=$(!1),d=$(null);$e(()=>{ye.current==="studio"&&!e(r)&&(_(r,!0),ha(()=>import("./index-CBq2njpw.js"),__vite__mapDeps([0,1,2])).then(y=>{_(d,y.StudioEditor,!0)}))});function p(){ye.current==="playground"&&Ke.current&&(Un({dmnXml:Ke.current.dmnXml,facts:Ke.facts}),ye.bumpStudioHandoff())}var m=to(),u=ce(m),D=c(l(u),2),E=l(D);{let y=me(()=>ye.current==="studio"?Pe("playground"):Pe("studio")),P=me(()=>ye.current==="studio"?"page":void 0);je(E,{variant:"secondary",class:"nav-button",get href(){return e(y)},get"aria-current"(){return e(P)},onclick:p,children:(z,de)=>{var ee=xe();M(()=>F(ee,ye.current==="studio"?"Back to Playground":"Open Studio")),o(z,ee)},$$slots:{default:!0}})}var R=c(E,2);{let y=me(()=>ye.current==="sdk-sandbox"?Pe("playground"):Pe("sdk-sandbox")),P=me(()=>ye.current==="sdk-sandbox"?"page":void 0);je(R,{variant:"secondary",class:"nav-button",get href(){return e(y)},get"aria-current"(){return e(P)},children:(z,de)=>{var ee=xe();M(()=>F(ee,ye.current==="sdk-sandbox"?"Hide SDK Sandbox":"Try the JS/TS SDK")),o(z,ee)},$$slots:{default:!0}})}var v=c(R,2);{let y=me(()=>ye.current==="docs"?Pe("playground"):Pe("docs")),P=me(()=>ye.current==="docs"?"page":void 0);je(v,{variant:"secondary",class:"nav-button",get href(){return e(y)},get"aria-current"(){return e(P)},children:(z,de)=>{var ee=xe();M(()=>F(ee,ye.current==="docs"?"Back to Playground":"SDK Docs")),o(z,ee)},$$slots:{default:!0}})}var T=c(v,2);{var C=y=>{{let P=me(()=>ye.current==="account"?Pe("playground"):Pe("account")),z=me(()=>ye.current==="account"?"page":void 0);je(y,{variant:"secondary",class:"nav-button",get href(){return e(P)},get"aria-current"(){return e(z)},children:(de,ee)=>{var se=qe(),b=ce(se);{var f=Y=>{var ae=xe("Hide Account");o(Y,ae)},x=Y=>{var ae=xe();M(()=>F(ae,`Signed in${be.orgName?` — ${be.orgName}`:""}`)),o(Y,ae)},A=Y=>{var ae=xe("Sign in to save rulesets");o(Y,ae)};H(b,Y=>{ye.current==="account"?Y(f):be.token?Y(x,1):Y(A,-1)})}o(de,se)},$$slots:{default:!0}})}};H(T,y=>{y(C)})}var j=c(u,2);let L;var te=l(j);{var ie=y=>{zr(y,{})},g=y=>{var P=Mn(),z=l(P);Pr(z,{}),o(y,P)},s=y=>{Hr(y)},S=y=>{Yr(y)},G=y=>{var P=Qr(),z=ce(P);{var de=se=>{var b=Mn(),f=l(b);fr(f,{}),o(se,b)};H(z,se=>{ye.current==="account"&&se(de)})}var ee=c(z,2);Vi(ee,{}),o(y,P)};H(te,y=>{ye.current==="docs"?y(ie):ye.current==="sdk-sandbox"?y(g,1):ye.current==="privacy"?y(s,2):ye.current==="terms"?y(S,3):y(G,-1)})}var ge=c(j,2);{var pe=y=>{var P=$r();let z;var de=l(P);{var ee=b=>{var f=qe(),x=ce(f);fa(x,()=>ye.studioHandoffTick,A=>{var Y=qe(),ae=ce(Y);va(ae,()=>e(d),(K,W)=>{W(K,{})}),o(A,Y)}),o(b,f)},se=b=>{var f=Zr();o(b,f)};H(de,b=>{e(d)?b(ee):b(se,-1)})}M(()=>z=We(P,1,"studio-wrap svelte-1n46o8q",null,z,{hidden:ye.current!=="studio"})),o(y,P)};H(ge,y=>{e(r)&&y(pe)})}var _e=c(ge,2);let Ee;var fe=c(l(_e));{var re=y=>{var P=xe("Playing with examples requires no network overhead. (Signing in to save rulesets does.)");o(y,P)};H(fe,y=>{y(re)})}var Me=c(fe,2),oe=c(l(Me)),h=c(oe,2),I=c(h,2),Z=c(I,2);{var k=y=>{var P=eo(),z=c(l(P));ne(z,"title","93016bcd81907cfb7d1559310de3fe835c49aa30"),z.textContent="93016bc";var de=c(z);de.nodeValue=`,
        built 2026-07-25T16:26:59.166Z`,o(y,P)};H(Z,y=>{e(i)&&y(k)})}M((y,P)=>{L=We(j,1,"svelte-1n46o8q",null,L,{hidden:ye.current==="studio"}),Ee=We(_e,1,"fine svelte-1n46o8q",null,Ee,{hidden:ye.current==="studio"}),ne(oe,"href",y),ne(h,"href",P)},[()=>Pe("privacy"),()=>Pe("terms")]),ue("click",I,()=>_(i,!e(i))),o(n,m),Le()}Ge(["click"]);ga(no,{target:document.getElementById("app")});export{yn as D,wt as E,co as L,$t as a,_n as b,lo as c,ro as d,cn as e,Ba as i,uo as l,Fa as p,so as s,oo as u};
