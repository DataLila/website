...
console.log(result); // { approved: ..., amount: ... }`);async function b(){if(!("serviceWorker"in navigator)){y(g,"Service Workers are not available in this browser.");return}if(await navigator.serviceWorker.register("/bre/sdk-sandbox-sw.js",{scope:"/bre/"}),await navigator.serviceWorker.ready,!navigator.serviceWorker.controller){y(i,"First-time setup: reloading to activate the local sandbox..."),window.location.reload();return}}async function h(){y(g,null);try{y(i,"Running real datalila-bre code against the local sandbox..."),c=new bt.BreClient({endpoint:"/bre/mock-api",apiKey:"sandbox-key"}),await c.ready,await c.syncOnce(),y(p,c.evaluate("mortgage_eligibility",{dti:e(r),credit_score:e(s)}),!0),y(i,"Done -- zero network calls left the browser."),y(a,!0)}catch(N){y(g,(N==null?void 0:N.message)??String(N),!0),y(i,"Failed.")}}function m(){if(c)try{y(p,c.evaluate("mortgage_eligibility",{dti:e(r),credit_score:e(s)}),!0),y(g,null)}catch(N){y(g,(N==null?void 0:N.message)??String(N),!0)}}lt(async()=>{var N;await b(),(N=navigator.serviceWorker)!=null&&N.controller&&await h()});var O=na(),j=d(o(O),4),k=o(j),T=d(o(k),2),z=o(T),L=d(k,2),_=d(o(L),2),l=d(o(_)),I=d(_,2),Y=d(o(I)),ae=d(I,2),F=o(ae),ne=d(ae,2);{var u=N=>{var U=ea(),D=o(U);B(()=>P(D,e(g))),w(N,U)};$(ne,N=>{e(g)&&N(u)})}var R=d(ne,2);{var K=N=>{var U=ta(),D=d(o(U),2),H=o(D);B(re=>P(H,re),[()=>JSON.stringify(e(p),(re,ce)=>{var ye,de;return(de=(ye=bt.Decimal).isDecimal)!=null&&de.call(ye,ce)?ce.toString():ce},2)]),w(N,U)};$(R,N=>{e(p)&&N(K)})}B(()=>{P(z,e(S)),P(F,e(i))}),J("input",l,m),Me(l,()=>e(r),N=>y(r,N)),J("input",Y,m),Me(Y,()=>e(s),N=>y(s,N)),w(n,O),De()}je(["input"]);const ze=[{id:"rust",label:"Rust",packageName:"bre-core (path dependency -- no separate SDK crate)",language:"rust",sourcePath:"docs/sdk-examples/rust/src/main.rs",code:`use bre_core::Engine;
use serde_json::json;
...
`)}var la=C('<button type="button"> </button>'),ca=C('<p class="note svelte-65i1x3"> </p>'),ua=C(`<div class="docs svelte-65i1x3"><div class="intro svelte-65i1x3"><h1 class="svelte-65i1x3">SDK examples</h1> <p class="svelte-65i1x3">One real, runnable example per language target, evaluating the same
      ...
      run produced, not a hand-written guess.</p> <p class="mono small svelte-65i1x3">Shared DMN source: <code class="svelte-65i1x3">website/src/lib/dmn-examples/mortgage_eligibility.dmn</code> &middot; runnable copies of every example below live under <code class="svelte-65i1x3">docs/sdk-examples/</code> in the repo.</p></div> <nav class="tabs svelte-65i1x3" aria-label="SDK language"></nav> <section class="panel svelte-65i1x3"><div class="panel-head svelte-65i1x3"><h2 class="svelte-65i1x3"> </h2> <span class="pkg mono svelte-65i1x3"> </span></div> <!> <h3 class="svelte-65i1x3"> </h3> <pre class="code mono svelte-65i1x3"><code class="svelte-65i1x3"></code></pre> <h3 class="svelte-65i1x3">Run it yourself</h3> <pre class="steps mono svelte-65i1x3"><code class="svelte-65i1x3"> </code></pre> <h3 class="svelte-65i1x3">Actual output</h3> <pre class="output mono svelte-65i1x3"><code class="svelte-65i1x3"> </code></pre></section></div>`);function da(n,t){Te(t,!0);let i=V(Oe(ze[0].id)),a=Se(()=>ze.find(F=>F.id===e(i))??ze[0]);var r=ua(),s=d(o(r),2);be(s,21,()=>ze,F=>F.id,(F,ne)=>{var u=la();let R;var K=o(u);B(()=>{R=Re(u,1,"tab svelte-65i1x3",null,R,{active:e(ne).id===e(i)}),P(K,e(ne).label)}),J("click",u,()=>y(i,e(ne).id,!0)),w(F,u)});var p=d(s,2),g=o(p),c=o(g),S=o(c),b=d(c,2),h=o(b),m=d(g,2);{var O=F=>{var ne=ca(),u=o(ne);B(()=>P(u,e(a).note)),w(F,ne)};$(m,F=>{e(a).note&&F(O)})}var j=d(m,2),k=o(j),T=d(j,2),z=o(T);Nt(z,()=>oa(e(a).code,e(a).language),!0);var L=d(T,4),_=o(L),l=o(_),I=d(L,4),Y=o(I),ae=o(Y);B(F=>{P(S,e(a).label),P(h,e(a).packageName),P(k,`Example (${e(a).sourcePath??""})`),P(l,F),P(ae,e(a).output)},[()=>e(a).runSteps.join(`
`)]),w(n,r),De()}je(["click"]);const st={};var pa=C('<button type="button" class="account-toggle svelte-1n46o8q"> </button>'),ht=C('<div class="account-wrap svelte-1n46o8q"><!></div>'),ma=C("<!> <!>",1),va=C('<header class="bar svelte-1n46o8q"><div><span class="word svelte-1n46o8q">Datalila <span class="accent svelte-1n46o8q">BRE</span></span> <span class="tag svelte-1n46o8q">A 100% OMG Compliant Business Rules Engine. Executing live in your browser.</span></div> <nav class="svelte-1n46o8q"><a class="studio-link svelte-1n46o8q" href="/bre/studio/">Open Studio ↗</a> <button type="button" class="studio-link sdk-toggle svelte-1n46o8q"> </button> <button type="button" class="account-toggle svelte-1n46o8q"> </button> <!></nav></header> <main class="svelte-1n46o8q"><!></main> <footer class="fine svelte-1n46o8q">Running the actual Datalila BRE engine directly in your browser. Same code, same execution, zero server latency. <!></footer>',1);function ga(n,t){Te(t,!0);const i=(st==null?void 0:st.VITE_ENABLE_ACCOUNTS)!=="false";let a=V(!1),r=V(!1),s=V(!1);function p(){y(r,!e(r)),e(r)&&y(s,!1)}function g(){y(s,!e(s)),e(s)&&y(r,!1)}var c=va(),S=ke(c),b=d(o(S),2),h=d(o(b),2),m=o(h),O=d(h,2),j=o(O),k=d(O,2);{var T=u=>{var R=pa(),K=o(R);B(()=>P(K,e(a)?"Hide Account":"Sign in to save rulesets")),J("click",R,()=>y(a,!e(a))),w(u,R)};$(k,u=>{i&&u(T)})}var z=d(S,2),L=o(z);{var _=u=>{da(u,{})},l=u=>{var R=ht(),K=o(R);aa(K,{}),w(u,R)},I=u=>{var R=ma(),K=ke(R);{var N=D=>{var H=ht(),re=o(H);Pn(re,{}),w(D,H)};$(K,D=>{e(a)&&D(N)})}var U=d(K,2);jn(U,{}),w(u,R)};$(L,u=>{e(s)?u(_):e(r)?u(l,1):u(I,-1)})}var Y=d(z,2),ae=d(o(Y));{var F=u=>{var R=Je("Playing with examples requires no network overhead. (Signing in to save rulesets does.)");w(u,R)},ne=u=>{var R=Je("No network calls. No server round-trips.");w(u,R)};$(ae,u=>{i?u(F):u(ne,-1)})}B(()=>{P(m,e(r)?"Hide SDK Sandbox":"Try the JS/TS SDK"),P(j,e(s)?"Back to Playground":"SDK Docs")}),J("click",h,p),J("click",O,g),w(n,c),De()}je(["click"]);At(ga,{target:document.getElementById("app")});
